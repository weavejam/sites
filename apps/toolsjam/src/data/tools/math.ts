...
export const tools: ToolEntry[] = [
  ...
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "duoxiangshi-tongyong-juxing-jisuanqi",
      "zh-TW": "duoxiangshi-tongyong-juxing-jisuanqi",
      ja: "tayoushiki-bokkusu-ho-keisan",
      ko: "dahangsik-boseu-beob-gyesan",
      es: "calculadora-rectangulo-generico",
      fr: "calculatrice-rectangle-general",
      de: "allgemeiner-rechteck-rechner",
      pt: "calculadora-retangulo-generico",
      ru: "obshchii-pryamougolnik-kalkulyator"
    },
    titles: {
      ...
      ja: "多項式ボックス法計算機",
      ko: "다항식 박스법 계산기",
      es: "Calculadora de rectángulo genérico",
      fr: "Calculatrice de rectangle général",
      de: "Allgemeiner Rechteck-Rechner",
      pt: "Calculadora de retângulo genérico",
      ru: "Калькулятор общего прямоугольника"
    },
    descriptions: {
      ...
      "zh-CN": "用通用矩形盒法直观相乘多项式，立即查看完整乘法表和化简结果。",
      "zh-TW": "用通用矩形盒法直觀相乘多項式，立即查看完整乘法表與化簡結果。",
      ja: "ボックス法で多項式を視覚的に掛け算し、展開表と整理済みの答えをすぐ確認できます。",
      ko: "박스법으로 다항식을 시각적으로 곱하고 전개표와 정리된 결과를 바로 확인하세요.",
      es: "Multiplica polinomios con el método del rectángulo y ve al instante la tabla completa y el producto simplificado.",
      fr: "Multipliez des polynômes avec la méthode du rectangle et voyez instantanément la table complète et le produit simplifié.",
      de: "Multipliziere Polynome mit der Rechteckmethode und sieh sofort die vollständige Tabelle und das vereinfachte Produkt.",
      pt: "Multiplique polinômios com o método do retângulo e veja na hora a tabela completa e o produto simplificado.",
      ru: "Перемножайте многочлены методом прямоугольника и сразу смотрите полную таблицу и упрощённый результат."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "zuidagongyinshu-jisuanqi",
      "zh-TW": "zuidagongyinshu-jisuanqi",
      ja: "saidai-koyakusu-keisanki",
      ko: "gongyaksu-gyeonsangi",
      es: "calculadora-mcd",
      fr: "calculateur-pgcd",
      de: "ggt-rechner",
      pt: "calculadora-mdc",
      ru: "naibolshii-obshchii-delitel-kalkulyator"
    },
    titles: {
      ...
      ja: "最大公約数計算機",
      ko: "최대공약수 계산기",
      es: "Calculadora de MCD",
      fr: "Calculateur de PGCD",
      de: "GGT-Rechner",
    ...
    descriptions: {
      ...
      "zh-CN": "使用欧几里得算法或质因数分解计算两个或多个整数的最大公因数，并展示步骤。",
      "zh-TW": "使用歐幾里得演算法或質因數分解計算兩個或多個整數的最大公因數，並顯示步驟。",
      ja: "ユークリッドの互除法や素因数分解で2つ以上の整数の最大公約数を計算し、手順も表示します。",
      ko: "유클리드 알고리즘이나 소인수분해로 두 개 이상 정수의 최대공약수를 계산하고 과정을 보여줍니다.",
      es: "Calcula el máximo común divisor de dos o más enteros con Euclides o factorización y muestra los pasos.",
      fr: "Calculez le plus grand commun diviseur de deux entiers ou plus avec Euclide ou la factorisation, étapes à l’appui.",
      de: "Berechnen Sie den größten gemeinsamen Teiler von zwei oder mehr ganzen Zahlen mit Euclid oder Primfaktorzerlegung.",
      pt: "Calcule o máximo divisor comum de dois ou mais inteiros com Euclides ou fatoração, com passos detalhados.",
      ru: "Вычисляйте наибольший общий делитель двух и более чисел по Евклиду или разложению на простые множители."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "gong-yin-shu-gong-bei-shu-ji-suan-qi",
      "zh-TW": "gong-yin-shu-gong-bei-shu-ji-suan-qi",
      ja: "koyakusu-saisyoubaisu-keisan",
      ko: "gongyaksu-gongbaesu-gyeonsan",
      es: "calculadora-mcd-mcm",
      fr: "calculateur-pgcd-ppcm",
      de: "ggt-kgv-rechner",
      pt: "calculadora-mdc-mmc",
      ru: "nod-i-nok-kalkulyator"
    },
    titles: {
    ...
    descriptions: {
      ...
      "zh-CN": "快速计算任意一组数字的最大公因数和最小公倍数，支持两个或更多正整数，并使用欧几里得算法。",
      "zh-TW": "快速計算任意一組數字的最大公因數與最小公倍數，支援兩個或更多正整數，並使用歐幾里得演算法。",
      ja: "任意の正の整数列の最大公約数と最小公倍数をすぐに計算します。ユークリッドの互除法を使い、2個以上に対応します。",
      ko: "두 개 이상 양의 정수의 최대공약수와 최소공배수를 즉시 계산합니다. 유클리드 호제법을 사용합니다.",
      ...
      fr: "Calculez instantanément le PGCD et le PPCM de n'importe quel ensemble de nombres. Utilise l'algorithme d'Euclide pour deux entiers positifs ou plus.",
      de: "Berechnen Sie den GGT und das KGV beliebiger Zahlenmengen sofort. Nutzt den euklidischen Algorithmus und unterstützt zwei oder mehr positive ganze Zahlen.",
  ...
  },
  {
    ...
    slugs: {
      ...
      ja: "gausu-jordan-shokika-keisanki",
      ko: "gauseu-jodeon-sogeobeop-gyesangi",
      es: "calculadora-eliminacion-gauss-jordan",
      fr: "calculatrice-elimination-gauss-jordan",
      de: "gauss-jordan-eliminationsrechner",
      pt: "calculadora-eliminacao-gauss-jordan",
      ru: "kalkulyator-metoda-gaussa-zhordana"
    },
    titles: {
      ...
      ja: "ガウス・ジョルダン消去法計算機",
      ko: "가우스-조던 소거법 계산기",
      es: "Calculadora de eliminación de Gauss-Jordan",
      fr: "Calculatrice d’élimination de Gauss-Jordan",
      de: "Gauss-Jordan-Eliminationsrechner",
    ...
    descriptions: {
      ...
      "zh-CN": "使用高斯-约旦消元法求解线性方程组。输入增广矩阵即可得到 RREF 和精确解。",
      "zh-TW": "使用高斯-約旦消元法求解線性方程組。輸入增廣矩陣即可得到 RREF 和精確解。",
      ja: "ガウス・ジョルダン消去法で連立一次方程式を解きます。拡大係数行列を入力すると RREF と厳密解を表示します。",
      ko: "가우스-조던 소거법으로 연립 일차방정식을 풉니다. 확장 행렬을 입력하면 RREF와 정확한 해를 확인할 수 있습니다.",
      es: "Resuelve sistemas de ecuaciones lineales con eliminación de Gauss-Jordan. Ingresa tu matriz aumentada para obtener la RREF y la solución exacta.",
      ...
      de: "Löse lineare Gleichungssysteme mit der Gauss-Jordan-Elimination. Gib die erweiterte Matrix ein, um die RREF und die exakte Lösung zu erhalten.",
      pt: "Resolva sistemas de equações lineares com a eliminação de Gauss-Jordan. Insira a matriz aumentada para obter a RREF e a solução exata.",
  ...
  },
  {
    ...
    titles: {
      ...
      ja: "Gamma関数計算機 - Γ(z)をオンライン計算",
      ko: "감마 함수 계산기 - Γ(z) 온라인 계산",
      es: "Calculadora de la función gamma - Calcula Γ(z)",
      fr: "Calculateur de fonction gamma - Calculez Γ(z)",
      de: "Gamma-Funktionsrechner - Γ(z) online berechnen",
      pt: "Calculadora da função gama - Calcule Γ(z)",
      ru: "Калькулятор гамма-функции - Γ(z) онлайн"
    },
    descriptions: {
      ...
      "zh-CN": "使用 Lanczos 近似计算任意实数的 Gamma 函数 Γ(z)，快速求阶乘、积分与特殊函数结果。",
      "zh-TW": "使用 Lanczos 近似計算任意實數的 Gamma 函數 Γ(z)，快速求階乘、積分與特殊函數結果。",
      ja: "Lanczos近似で任意の実数のGamma関数Γ(z)を計算。階乗、積分、特殊関数にすぐ使えます。",
      ko: "Lanczos 근사로 임의의 실수의 감마 함수 Γ(z)를 계산합니다. 팩토리얼, 적분, 특수함수에 바로 쓸 수 있습니다.",
      ...
      de: "Berechnen Sie die Gamma-Funktion Γ(z) für jede reelle Zahl mit der Lanczos-Approximation. Sofortige Ergebnisse für Fakultäten und Integrale.",
      pt: "Calcule a função gama Γ(z) para qualquer número real com a aproximação de Lanczos. Resultados instantâneos para fatoriais e integrais.",
      ru: "Вычисляйте гамма-функцию Γ(z) для любого вещественного числа по приближению Ланцоша. Мгновенные результаты для факториалов и интегралов."
    }
  }
];
