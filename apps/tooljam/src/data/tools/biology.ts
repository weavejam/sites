...
export const tools: ToolEntry[] = [
  {
    ...
    slugs: {
      ...
      "zh-CN": "mu-mei-xiaoshi-zuoye-sulv-jisuanqi",
      "zh-TW": "mu-mei-xiaoshi-zuoye-sulv-jisuanqi",
      ja: "sagyo-sokudo-keisan-ki",
      ko: "jageop-sogdo-gyesan-gi",
      es: "calculadora-rendimiento-horas-acre",
      fr: "calculateur-rendement-heure-hectare",
      de: "akre-pro-stunde-rechner",
      pt: "calculadora-hectares-por-hora",
    ...
    titles: {
      ...
      de: "Arbeitsrate-Rechner",
      pt: "Calculadora de rendimento por hora",
    ...
    descriptions: {
      ...
      "zh-CN": "根据面积和时间，或机器宽度、速度与效率计算每小时亩数或公顷数。",
      "zh-TW": "依面積與時間，或機具寬度、速度與效率，計算每小時畝數或公頃數。",
      ja: "面積と時間、または機械幅・速度・効率から、1時間あたりの面積を計算します。",
      ko: "면적과 시간, 또는 기계 폭·속도·효율로 시간당 작업 면적을 계산합니다.",
      es: "Calcula el rendimiento de trabajo por hora en acres o hectáreas a partir del área y el tiempo, o del ancho, velocidad y eficiencia.",
      fr: "Calculez le rendement de travail par heure en acres ou en hectares à partir de la surface et du temps, ou de la largeur, vitesse et efficacité.",
      de: "Berechnen Sie die Arbeitsleistung pro Stunde in Acres oder Hektar aus Fläche und Zeit oder aus Breite, Geschwindigkeit und Effizienz.",
      pt: "Calcule o rendimento de trabalho por hora em acres ou hectares a partir da área e do tempo, ou da largura, velocidade e eficiência.",
      ru: "Рассчитайте производительность работы в акрах или гектарах в час по площади и времени, либо по ширине, скорости и эффективности."
    }
  },
  {
