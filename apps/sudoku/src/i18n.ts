...
const dict: Record<Lang, Record<string, Entry>> = {
  zh: {
    ...
    achNames: "",
    hintExplainTitle: "使用提示前请知悉",
    hintExplainBody: "每次使用提示会自动罚时 +30 秒。\n两次提示之间至少间隔 30 秒。",
    hintExplainOk: "了解，使用提示",
    hintExplainCancel: "取消",
    hintCooldown: (s: number) => `请稍候，${s} 秒后才能再次使用提示`,
  },
  en: {
    title: "Sudoku",
    size4: "4×4",
    ...
    achNames: "",
    hintExplainTitle: "Heads up before using a hint",
    hintExplainBody: "Each hint adds a +30s time penalty.\nHints must be at least 30 seconds apart.",
    hintExplainOk: "Got it, use hint",
    hintExplainCancel: "Cancel",
    hintCooldown: (s: number) => `Please wait — next hint available in ${s}s`,
  },
};
