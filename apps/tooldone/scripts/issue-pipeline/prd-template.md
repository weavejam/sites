...
## Motivation
Part of the full tooldone.com → apps/tooldone migration (~568 batches × 5 pages = 2840 pages total). Each batch ships as one reviewable, revertable PR.
...
## Technical Approach
- Conventions: `apps/tooldone/scripts/port-batch-prompt.md` (authoritative)
...
- HTML snapshots: `D:\shudu\shudu\apps\tooldone\.scrape\html\<category>\<slug>.html` (already added to trusted dirs by worker)
