...
export default function ArcsinCalculator(_props: { locale: Locale }) {
  const t = useTranslations("tool.arcsin-calculator");
  ...
  const showInputError =
    touched && (inputValue === "" || (!Number.isFinite(xNum) && inputValue !== ""));
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="arcsin-input">{t("field.value")}</Label>
            <Input
              id="arcsin-input"
              type="number"
              inputMode="decimal"
