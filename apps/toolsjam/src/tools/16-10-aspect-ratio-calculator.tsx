...
export default function AspectRatio1610Calculator(_props: { locale: Locale }) {
  const t = useTranslations("tool.16-10-aspect-ratio-calculator");
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="space-y-2">
              <Label htmlFor="ar1610-w">{t("field.width")}</Label>
              <Input
                id="ar1610-w"
                type="number"
                inputMode="decimal"
            ...
            <div className="space-y-2">
              <Label htmlFor="ar1610-h">{t("field.height")}</Label>
              <Input
                id="ar1610-h"
                type="number"
                inputMode="decimal"
            ...
            <div className="space-y-2">
              <Label htmlFor="ar1610-d">{t("field.diagonal")}</Label>
              <Input
                id="ar1610-d"
                type="number"
                inputMode="decimal"
