...
export const tools: ToolEntry[] = [
  ...
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "dian-dao-lu-zhuan-dian-zu-lu-ji-suan-qi",
      "zh-TW": "dian-dao-lu-zhuan-dian-zu-lu-ji-suan-qi",
      ja: "dendoritsu-teikoritsu-keisanki",
      ko: "jeondoyul-bijeohangnyul-gyesangi",
      es: "calculadora-conductividad-resistividad",
      fr: "calculateur-conductivite-resistivite",
      de: "leitfaehigkeit-spezifischer-widerstand-rechner",
      pt: "calculadora-condutividade-resistividade",
      ru: "provodimost-udelnoe-soprotivlenie-kalkulyator"
    },
    titles: {
      en: "Conductivity to Resistivity Calculator – Convert σ to ρ",
      "zh-CN": "电导率转电阻率计算器 – σ 转 ρ",
      "zh-TW": "電導率轉電阻率計算器 – σ 轉 ρ",
      ja: "導電率から抵抗率計算機 – σ を ρ に変換",
      ko: "전도율-비저항 계산기 – σ를 ρ로 변환",
      es: "Calculadora de conductividad a resistividad",
      fr: "Calculateur conductivité en résistivité",
      de: "Leitfähigkeit in spezifischen Widerstand",
      pt: "Calculadora de condutividade para resistividade",
      ru: "Калькулятор проводимости в сопротивление"
    },
    descriptions: {
      ...
      "zh-CN": "电导率转电阻率计算器：通过 ρ = 1/σ 将电导率 (S/m) 转为电阻率 (Ω·m)，适用于导体、半导体和绝缘体。",
      "zh-TW": "電導率轉電阻率計算器：透過 ρ = 1/σ 將電導率 (S/m) 轉為電阻率 (Ω·m)，適用於導體、半導體與絕緣體。",
      ja: "導電率から抵抗率へ：ρ = 1/σ で電気伝導率 (S/m) を抵抗率 (Ω·m) に変換。導体、半導体、絶縁体に対応。",
      ko: "전도율-비저항 계산기: ρ = 1/σ로 전기 전도율(S/m)을 비저항(Ω·m)으로 변환합니다. 도체, 반도체, 절연체에 사용하세요.",
      es: "Calcula la resistividad desde la conductividad eléctrica (S/m) con ρ = 1/σ y obtén Ω·m para conductores, semiconductores y aislantes.",
      fr: "Convertissez la conductivité électrique (S/m) en résistivité (Ω·m) avec ρ = 1/σ pour conducteurs, semi-conducteurs et isolants.",
      de: "Rechner für Leitfähigkeit in spezifischen Widerstand: Wandle elektrische Leitfähigkeit (S/m) mit ρ = 1/σ in Ω·m um.",
      pt: "Converta condutividade elétrica (S/m) em resistividade (Ω·m) com ρ = 1/σ para condutores, semicondutores e isolantes.",
      ru: "Переведите электропроводность (S/m) в удельное сопротивление (Ω·m) по ρ = 1/σ для проводников, полупроводников и изоляторов."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "rongliang-kangzu-jisuanqi-xc-gongshi",
      "zh-TW": "rongliang-kangzu-jisuanqi-xc-gongshi",
      ja: "youshitaisu-sanshiki-xc-keisan",
      ko: "yongryang-jehang-jisuan-gi-xc-sig",
      es: "calculadora-reactancia-capacitiva-xc",
      fr: "calculateur-reactance-capacitive-xc",
      de: "kapazitiver-reaktanzrechner-xc-formel",
      pt: "calculadora-reatancia-capacitiva-xc",
      ru: "emkostnoe-soprotivlenie-kalkulyator-xc"
    },
    titles: {
      en: "Capacitive Reactance Calculator – Xc Formula",
      "zh-CN": "容抗计算器：Xc 公式",
      "zh-TW": "容抗計算器：Xc 公式",
      ja: "容量リアクタンス計算機：Xc 公式",
      ko: "용량 리액턴스 계산기: Xc 공식",
      es: "Calculadora de reactancia capacitiva: Xc",
      fr: "Calculateur de réactance capacitive : Xc",
      de: "Kapazitiver Reaktanzrechner: Xc",
      pt: "Calculadora de reatância capacitiva: Xc",
      ru: "Калькулятор ёмкостного сопротивления: Xc"
    },
    descriptions: {
      ...
      "zh-CN": "使用 Xc = 1/(2πfC) 计算任意频率和电容的容抗。面向电子工程师的免费在线交流电路分析工具。",
      "zh-TW": "使用 Xc = 1/(2πfC) 計算任意頻率與電容量的容抗。面向電子工程師的免費交流電路分析工具。",
      ja: "Xc = 1/(2πfC) を使って、任意の周波数と容量の容量リアクタンスを計算します。電子技術者向けの無料AC回路解析ツールです。",
      ko: "Xc = 1/(2πfC)로 임의의 주파수와 정전용량의 용량 리액턴스를 계산합니다. 전자 엔지니어를 위한 무료 AC 회로 분석 도구입니다.",
      es: "Calcula la reactancia capacitiva (Xc) para cualquier frecuencia y capacitancia con Xc = 1/(2πfC). Herramienta gratuita para circuitos AC.",
      fr: "Calculez la réactance capacitive (Xc) pour toute fréquence et capacité avec Xc = 1/(2πfC). Outil AC gratuit pour les électroniciens.",
      de: "Berechnen Sie die kapazitive Reaktanz (Xc) für jede Frequenz und Kapazität mit Xc = 1/(2πfC). Kostenloses AC-Schaltungstool für Elektroniker.",
      pt: "Calcule a reatância capacitiva (Xc) para qualquer frequência e capacitância com Xc = 1/(2πfC). Ferramenta AC gratuita para eletrônicos.",
      ru: "Рассчитайте ёмкостное сопротивление (Xc) для любой частоты и ёмкости по формуле Xc = 1/(2πfC). Бесплатный инструмент для AC-схем."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "dianrong-jiangya-dianyuan-jisuanqi",
      "zh-TW": "dianrong-jiangya-dianyuan-jisuanqi",
      ja: "kondensa-kouatsu-dengen-keisanki",
      ko: "keopaesiteo-gangha-jeonwon-gyesangi",
      es: "fuente-capacitiva-sin-transformador",
      fr: "alimentation-capacitive-sans-transformateur",
      de: "kapazitives-netzteil-ohne-transformator",
      pt: "fonte-capacitiva-sem-transformador",
      ru: "kalkulyator-emkostnogo-bp-bez-transformatora"
    },
    titles: {
      en: "Capacitive Transformerless Power Supply Calculator",
      "zh-CN": "电容降压电源计算器",
      ...
      ja: "コンデンサ降圧電源計算機",
      ko: "커패시터 강하 전원 계산기",
      es: "Calculadora de fuente capacitiva sin transformador",
      fr: "Calculatrice d'alimentation capacitive sans transformateur",
      de: "Kapazitives Netzteil ohne Transformator berechnen",
      pt: "Calculadora de fonte capacitiva sem transformador",
      ru: "Калькулятор емкостного БП без трансформатора"
    },
    descriptions: {
      ...
      "zh-CN": "设计电容降压电源：计算降压电容容抗、直流负载电流和稳压管功耗。",
      "zh-TW": "設計電容降壓電源：計算降壓電容容抗、直流負載電流與穩壓管功耗。",
      ja: "コンデンサ降圧電源を設計し、降下コンデンサのリアクタンス、直流電流、ツェナー損失を計算します。",
      ko: "커패시터 강하 전원을 설계하고 드롭 커패시터 리액턴스, DC 전류, 지너 손실을 계산합니다.",
      es: "Diseña fuentes capacitivas sin transformador: calcula la reactancia del condensador de caída, la corriente DC y la potencia del zener.",
      fr: "Concevez des alimentations capacitatives sans transformateur : calculez la réactance du condensateur de chute, le courant DC et la puissance Zener.",
      de: "Kapazitive Netzteile ohne Transformator entwerfen: Reaktanz des Abwärtskondensators, Gleichstrom und Zener-Verlustleistung berechnen.",
      pt: "Projete fontes capacitivas sem transformador: calcule a reatância do capacitor de queda, a corrente CC e a potência no zener.",
      ru: "Проектируйте емкостные бестрансформаторные источники питания: рассчитывайте реактивное сопротивление гасящего конденсатора, ток DC и мощность стабилитрона."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "dianrong-qi-ji-suan-qi",
      "zh-TW": "dian-rong-qi-ji-suan-qi",
      ja: "kon-densa-keisan",
      ko: "kaepasiteo-gyesangi",
      es: "calculadora-condensador",
      fr: "calculateur-condensateur",
      de: "kondensator-rechner",
      pt: "calculadora-capacitor",
      ru: "kalkulyator-kondensatora"
    },
    titles: {
      en: "Capacitor Calculator – Charge, Voltage, and Plate Geometry",
      "zh-CN": "电容器计算器 - 电荷、电压与极板几何",
      "zh-TW": "電容器計算器 - 電荷、電壓與極板幾何",
      ja: "コンデンサ計算機 - 電荷・電圧・平板形状",
      ko: "커패시터 계산기 - 전하, 전압, 판 형상",
      es: "Calculadora de condensadores: carga, voltaje y placas",
      fr: "Calculateur de condensateur - charge, tension et plaques",
      de: "Kondensator-Rechner: Ladung, Spannung und Platten",
      pt: "Calculadora de capacitor: carga, tensão e placas",
      ru: "Калькулятор конденсатора: заряд, напряжение и пластины"
    },
    descriptions: {
      ...
      "zh-CN": "电容器计算器：用 Q = CV 求电荷、电容或电压，或根据几何尺寸和介电常数计算平行板电容。",
      "zh-TW": "電容器計算器：用 Q = CV 求電荷、電容或電壓，或依幾何尺寸與介電常數計算平行板電容。",
      ja: "コンデンサ計算機：Q = CV で電荷・静電容量・電圧を求め、形状と誘電率から平行平板容量も計算できます。",
      ko: "커패시터 계산기: Q = CV로 전하, 정전용량, 전압을 구하거나 형상과 유전율로 평행판 정전용량을 계산합니다.",
      es: "Calculadora de condensadores: halla carga, capacitancia o voltaje con Q = CV, o calcula placas paralelas con geometría y dieléctrico.",
      fr: "Calculateur de condensateur : trouvez charge, capacité ou tension avec Q = CV, ou calculez une capacité à plaques parallèles.",
      de: "Kondensator-Rechner: Ladung, Kapazität oder Spannung mit Q = CV berechnen oder Plattenkapazität aus Geometrie und Dielektrikum.",
      pt: "Calculadora de capacitor: encontre carga, capacitância ou tensão com Q = CV, ou calcule placas paralelas por geometria e dielétrico.",
      ru: "Калькулятор конденсатора: найдите заряд, емкость или напряжение по Q = CV либо рассчитайте емкость плоских пластин."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "dian-rong-chong-dian-shi-jian-rc-dian-lu-ji-suan-qi",
      "zh-TW": "dian-rong-chong-dian-shi-jian-rc-dian-lu-ji-suan-qi",
      ja: "kondensa-juden-jikan-rc-kairo-keisanki",
      ko: "keopaesiteo-chungjeon-sigan-rc-hoero-gyesangi",
      es: "calculadora-tiempo-carga-condensador-circuito-rc",
      fr: "calculateur-temps-charge-condensateur-circuit-rc",
      de: "kondensator-ladezeit-rechner-rc-schaltung",
      pt: "calculadora-tempo-carga-capacitor-circuito-rc",
      ru: "kalkulyator-vremeni-zaryada-kondensatora-rc-cep"
    },
    titles: {
      en: "Capacitor Charge Time Calculator – RC Circuit",
      "zh-CN": "电容充电时间计算器 – RC 电路",
      "zh-TW": "電容充電時間計算器 – RC 電路",
      ja: "コンデンサ充電時間計算機 – RC回路",
      ko: "커패시터 충전 시간 계산기 – RC 회로",
      es: "Calculadora de carga de condensador RC",
      fr: "Calculateur de charge de condensateur RC",
      de: "Kondensator-Ladezeitrechner für RC",
      pt: "Calculadora de carga de capacitor RC",
      ru: "Калькулятор заряда конденсатора RC"
    },
    descriptions: {
      ...
      "zh-CN": "用 t = −RC × ln(1 − Vc/Vs) 计算 RC 电路电容充电时间、RC 时间常数和电压里程碑。",
      "zh-TW": "用 t = −RC × ln(1 − Vc/Vs) 計算 RC 電路電容充電時間、RC 時間常數與電壓里程碑。",
      ja: "t = −RC × ln(1 − Vc/Vs) で RC 回路の充電時間、RC 時定数、電圧マイルストーンを計算します。",
      ko: "t = −RC × ln(1 − Vc/Vs) 로 RC 회로의 충전 시간, RC 시정수, 전압 기준점을 계산합니다.",
      es: "Calcula el tiempo de carga en circuitos RC con t = −RC × ln(1 − Vc/Vs), la constante RC y hitos de voltaje.",
      fr: "Calculez le temps de charge RC avec t = −RC × ln(1 − Vc/Vs), la constante de temps et les jalons de tension.",
      de: "Berechne RC-Ladezeit mit t = −RC × ln(1 − Vc/Vs), Zeitkonstante und Spannungsmarken.",
      pt: "Calcule o tempo de carga RC com t = −RC × ln(1 − Vc/Vs), a constante de tempo e marcos de tensão.",
      ru: "Рассчитайте время заряда RC по t = −RC × ln(1 − Vc/Vs), постоянную времени и вехи напряжения."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "dian-rong-qi-neng-liang-ji-suan-qi",
      "zh-TW": "dian-rong-qi-neng-liang-ji-suan-qi",
      ja: "kondensa-enerugi-keisan",
      ko: "keopeositeo-eneoji-gyesangi",
      es: "calculadora-energia-condensador",
      fr: "calculateur-energie-condensateur",
      de: "kondensator-energie-rechner",
      pt: "calculadora-energia-capacitor",
      ru: "kalkulyator-energii-kondensatora"
    },
    titles: {
      ...
      ja: "コンデンサエネルギー計算機",
      ko: "커패시터 에너지 계산기",
      es: "Calculadora de energía del condensador",
      fr: "Calculateur d’énergie du condensateur",
      de: "Kondensator-Energie-Rechner",
      pt: "Calculadora de energia do capacitor",
      ru: "Калькулятор энергии конденсатора"
    },
    descriptions: {
      ...
      "zh-CN": "使用 E = ½ × C × V² 计算电容器储能，快速得到焦耳结果，适用于电子、电力系统和电气工程。",
      "zh-TW": "使用 E = ½ × C × V² 計算電容器儲能，快速得到焦耳結果，適用於電子、電力系統與電機工程。",
      ja: "E = ½ × C × V² でコンデンサの蓄積エネルギーを計算し、電子回路や電気工学向けにジュールを即時表示します。",
      ko: "E = ½ × C × V²로 커패시터 저장 에너지를 계산해 전자공학과 전력 시스템용 줄 결과를 즉시 보여줍니다.",
      es: "Calcula la energía almacenada en un condensador con E = ½ × C × V². Resultado instantáneo en joules para electrónica y potencia.",
      fr: "Calculez l’énergie stockée dans un condensateur avec E = ½ × C × V². Résultat instantané en joules pour l’électronique et la puissance.",
      de: "Berechnen Sie die im Kondensator gespeicherte Energie mit E = ½ × C × V². Sofortiges Joule-Ergebnis für Elektronik und Leistungstechnik.",
      pt: "Calcule a energia armazenada em um capacitor com E = ½ × C × V². Resultado instantâneo em joules para eletrônica e potência.",
      ru: "Рассчитайте энергию, запасённую в конденсаторе, по E = ½ × C × V². Мгновенный результат в джоулях для электроники и энергетики."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "dian-rong-qi-chi-cun-ji-suan-qi",
      "zh-TW": "dian-rong-qi-chi-cun-ji-suan-qi",
      ja: "kondensa-saizu-keisanki",
      ko: "keopaesiteo-keugi-gyesangi",
      es: "calculadora-tamano-capacitor",
      fr: "calculateur-taille-condensateur",
      de: "kondensator-groesse-rechner",
      pt: "calculadora-tamanho-capacitor",
      ru: "kalkulyator-razmera-kondensatora"
    },
    titles: {
      ...
      ja: "コンデンササイズ計算機",
      ko: "커패시터 크기 계산기",
      es: "Calculadora de tamaño de capacitor",
      fr: "Calculateur de taille de condensateur",
      de: "Kondensatorgrößen-Rechner",
      pt: "Calculadora de tamanho de capacitor",
      ru: "Калькулятор размера конденсатора"
    },
    descriptions: {
      ...
      "zh-CN": "根据电容量、电压和介电常数计算电容器的极板面积、储能和功率密度，适用于电子设计。",
      "zh-TW": "依據電容量、電壓與介電常數計算電容器的極板面積、儲能與功率密度，適合電子設計使用。",
      ja: "静電容量、電圧、誘電率からコンデンサの極板面積、蓄積エネルギー、電力密度を計算します。電子設計に最適です。",
      ko: "정전용량, 전압, 유전율로 커패시터의 판 면적, 저장 에너지, 전력 밀도를 계산합니다. 전자 설계에 적합합니다.",
      es: "Calcula el área de placas, la energía almacenada y la densidad de potencia de un capacitor a partir de capacitancia, voltaje y constante dieléctrica.",
      fr: "Calculez la surface des plaques, l’énergie stockée et la densité de puissance d’un condensateur à partir de sa capacité, tension et constante diélectrique.",
      de: "Berechnen Sie Plattenfläche, gespeicherte Energie und Leistungsdichte eines Kondensators aus Kapazität, Spannung und Dielektrizitätskonstante.",
      pt: "Calcule a área das placas, a energia armazenada e a densidade de potência de um capacitor a partir da capacitância, tensão e constante dielétrica.",
      ru: "Рассчитайте площадь обкладок, запасённую энергию и плотность мощности конденсатора по ёмкости, напряжению и диэлектрической проницаемости."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "chuanlian-dianrongqi-jisuanqi",
      "zh-TW": "chuanlian-dianrongqi-jisuanqi",
      ja: "chokuretsu-kondensa-keisan-ki",
      ko: "jigyeol-kondeonsa-gyesangi",
      es: "calculadora-capacitores-serie",
      fr: "calculateur-condensateurs-serie",
      de: "kondensatoren-in-reihe-rechner",
      pt: "calculadora-capacitores-em-serie",
      ru: "kondensatory-posledovatelno-kalkulyator"
    },
    titles: {
      ...
      ja: "直列コンデンサ計算機",
      ko: "직렬 커패시터 계산기",
      es: "Calculadora de capacitores en serie",
      fr: "Calculateur de condensateurs en série",
      de: "Kondensatoren in Reihe Rechner",
      pt: "Calculadora de capacitores em série",
      ru: "Калькулятор конденсаторов последовательно"
    },
    descriptions: {
      ...
      "zh-CN": "计算最多四个串联电容器的等效电容、电荷、电压分配和储能。",
      "zh-TW": "計算最多四個串聯電容器的等效電容、電荷、電壓分配和儲能。",
      ja: "最大4個の直列コンデンサの等価容量、電荷、電圧分配、蓄積エネルギーを計算します。",
      ko: "최대 4개의 직렬 커패시터의 등가 정전용량, 전하, 전압 분배, 저장 에너지를 계산합니다.",
      es: "Calcula la capacitancia equivalente, la carga, la distribución de voltaje y la energía almacenada de hasta cuatro capacitores en serie.",
      fr: "Calcule la capacité équivalente, la charge, la répartition de la tension et l’énergie stockée pour jusqu’à quatre condensateurs en série.",
      de: "Berechnet die Ersatzkapazität, die Ladung, die Spannungsverteilung und die gespeicherte Energie für bis zu vier Kondensatoren in Reihe.",
      pt: "Calcule a capacitância equivalente, a carga, a distribuição de tensão e a energia armazenada para até quatro capacitores em série.",
      ru: "Рассчитайте эквивалентную ёмкость, заряд, распределение напряжения и запасённую энергию для до четырёх последовательно соединённых конденсаторов."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "qiche-zhixin-jisuanqi",
      "zh-TW": "qiche-zhixin-jisuanqi",
      ja: "sha-juushin-keisanki",
      ko: "jadongcha-mugyo-jungsim-gyesangi",
      es: "calculadora-centro-masa-coche",
      fr: "calculateur-centre-masse-voiture",
      de: "auto-schwerpunkt-rechner",
      pt: "calculadora-centro-massa-carro",
      ru: "kalkulyator-tsentra-mass-avtomobilya"
    },
    titles: {
      ...
      ja: "車の重心計算機",
      ko: "자동차 무게중심 계산기",
      es: "Calculadora del centro de masa del coche",
      fr: "Calculateur du centre de masse voiture",
      de: "Auto-Schwerpunkt-Rechner",
      pt: "Calculadora de centro de massa do carro",
      ru: "Калькулятор центра масс автомобиля"
    },
    descriptions: {
      ...
      "zh-CN": "计算任意车辆的三维重心。添加各部件的质量和坐标，精准分析车辆动态、赛车调校与安全性。",
      "zh-TW": "計算任意車輛的三維重心。加入各部件的質量與座標，精準分析車輛動態、賽車調校與安全性。",
      ja: "あらゆる車両の3D重心を計算。各部品の質量と座標を入力して、車両挙動・安全性・モータースポーツ解析に活用できます。",
      ko: "모든 차량의 3D 무게중심을 계산하세요. 부품의 질량과 좌표를 입력해 차량 거동, 안전, 모터스포츠 분석에 활용할 수 있습니다.",
      es: "Calcula el centro de gravedad 3D de cualquier vehículo. Añade componentes con sus masas y coordenadas para analizar dinámica, seguridad y motorsport.",
      fr: "Calculez le centre de gravité 3D de n’importe quel véhicule. Ajoutez des composants avec leurs masses et coordonnées pour l’analyse dynamique, sécurité et sport auto.",
      de: "Berechnen Sie den 3D-Schwerpunkt jedes Fahrzeugs. Fügen Sie Bauteile mit Massen und Koordinaten hinzu für Fahrdynamik, Sicherheit und Motorsport.",
      pt: "Calcule o centro de gravidade 3D de qualquer veículo. Adicione componentes com massas e coordenadas para análise de dinâmica, segurança e automobilismo.",
      ru: "Рассчитайте 3D-центр тяжести любого автомобиля. Добавляйте компоненты с массой и координатами для анализа динамики, безопасности и автоспорта."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "qiche-pengzhuang-jisuanqi",
      "zh-TW": "qiche-pengzhuang-jisuanqi",
      ja: "jidousha-shoutotsu-keisanki",
      ko: "jadongcha-chungdol-gyesangi",
      es: "calculadora-choque-autos",
      fr: "calculateur-accident-voiture",
      de: "autounfall-rechner",
      pt: "calculadora-colisao-carro",
      ru: "kalkulyator-avtomobilnykh-avarii"
    },
    titles: {
      ...
      ja: "自動車衝突計算機",
      ko: "차량 충돌 계산기",
      es: "Calculadora de choques de autos",
      fr: "Calculateur d'accident de voiture",
      de: "Autounfall-Rechner",
      pt: "Calculadora de colisão de carros",
      ru: "Калькулятор автомобильных аварий"
    },
    descriptions: {
      ...
      "zh-CN": "利用动量守恒分析汽车碰撞，计算非弹性碰撞的终速度、损失的能量和冲量。支持 kg、lb、m/s、km/h、mph。",
      "zh-TW": "利用動量守恆分析汽車碰撞，計算非彈性碰撞的終速度、損失的能量與衝量。支援 kg、lb、m/s、km/h、mph。",
      ja: "運動量保存則で自動車衝突を解析し、非弾性衝突の終速度、失われる運動エネルギー、力積を計算します。kg、lb、m/s、km/h、mph に対応。",
      ko: "운동량 보존으로 차량 충돌을 분석하고 비탄성 충돌의 최종 속도, 손실된 운동에너지, 충격량을 계산합니다. kg, lb, m/s, km/h, mph 지원.",
      es: "Analiza choques de autos con conservación del momento y calcula velocidad final, energía perdida e impulso en colisiones inelásticas. Admite kg, lb, m/s, km/h y mph.",
      fr: "Analysez les accidents de voiture grâce à la conservation de la quantité de mouvement et calculez vitesse finale, énergie perdue et impulsion pour les collisions inélastiques. kg, lb, m/s, km/h, mph pris en charge.",
      de: "Analysieren Sie Autounfälle mit dem Impulserhaltungssatz und berechnen Sie Endgeschwindigkeit, Energieverlust und Impuls bei unelastischen Kollisionen. Unterstützt kg, lb, m/s, km/h, mph.",
      pt: "Analise colisões de carros com conservação do momento e calcule velocidade final, energia perdida e impulso em colisões inelásticas. Suporta kg, lb, m/s, km/h e mph.",
      ru: "Анализируйте автомобильные аварии по закону сохранения импульса и рассчитывайте конечную скорость, потерю энергии и импульс при неупругих столкновениях. Поддерживаются kg, lb, m/s, km/h, mph."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "qiche-feiyue-juli-jisuanqi",
      "zh-TW": "qiche-feiyue-juli-jisuanqi",
      ja: "kuruma-jump-kyori-keisanki",
      ko: "jadongcha-jeompeu-geori-gyesangi",
      es: "calculadora-distancia-salto-coche",
      fr: "calculateur-distance-saut-voiture",
      de: "auto-sprungweite-rechner",
      pt: "calculadora-distancia-salto-carro",
      ru: "kalkulyator-dalnosti-pryzhka-avto"
    },
    titles: {
      en: "Car Jump Distance Calculator – Projectile Motion",
      "zh-CN": "汽车飞跃距离计算器 - 抛体运动",
      "zh-TW": "汽車飛躍距離計算器 - 拋體運動",
      ja: "車のジャンプ距離計算機 - 放物運動",
      ko: "자동차 점프 거리 계산기 - 포물선 운동",
      es: "Calculadora de distancia de salto de coche",
      fr: "Calculateur de distance de saut de voiture",
      de: "Auto-Sprungweite-Rechner - Wurfbewegung",
      pt: "Calculadora de distância de salto de carro",
      ru: "Калькулятор дальности прыжка автомобиля"
    },
    descriptions: {
      ...
      "zh-CN": "根据起跳速度、角度和坡道高度，用抛体运动计算汽车飞跃距离、飞行时间和最大高度。支持 m/s、km/h 和 mph。",
      "zh-TW": "依起跳速度、角度與坡道高度，用拋體運動計算汽車飛躍距離、飛行時間與最大高度。支援 m/s、km/h 和 mph。",
      ja: "発射速度、角度、ランプ高さから、放物運動で車のジャンプ距離、飛行時間、最大高さを計算。m/s、km/h、mphに対応。",
      ko: "출발 속도, 각도, 램프 높이로 자동차 점프 거리, 비행 시간, 최대 높이를 포물선 운동으로 계산합니다. m/s, km/h, mph 지원.",
      es: "Calcula distancia de salto, tiempo de vuelo y altura máxima de un coche con velocidad, ángulo y altura de rampa usando movimiento parabólico.",
      fr: "Calculez distance de saut, temps de vol et hauteur maximale d'une voiture avec vitesse, angle et hauteur de rampe par mouvement projectile.",
      de: "Berechnen Sie Sprungweite, Flugzeit und maximale Höhe eines Autos aus Startgeschwindigkeit, Winkel und Rampenhöhe per Wurfbewegung.",
      pt: "Calcule distância de salto, tempo de voo e altura máxima de um carro com velocidade, ângulo e altura da rampa usando movimento de projéteis.",
      ru: "Рассчитайте дальность прыжка, время полета и максимальную высоту авто по скорости, углу и высоте рампы с помощью движения тела."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "zidan-nengliang-jisuanqi",
      "zh-TW": "zidan-nengliang-jisuanqi",
      ja: "dantou-enerugii-keisanki",
      ko: "tanhwan-eneoji-gyesangi",
      es: "calculadora-energia-bala",
      fr: "calculateur-energie-balle",
      de: "geschossenergie-rechner",
      pt: "calculadora-energia-projetil",
      ru: "kalkulyator-energii-puli"
    },
    titles: {
      en: "Bullet Energy Calculator – Muzzle Energy & Momentum",
      "zh-CN": "弹头能量计算器 - 枪口能量与动量",
      "zh-TW": "彈頭能量計算器 - 槍口能量與動量",
      ja: "弾頭エネルギー計算機 - 口径別の運動量",
      ko: "탄환 에너지 계산기 - 총구 에너지와 운동량",
      es: "Calculadora de energía de bala - energía y momento",
      fr: "Calculateur d'énergie de balle - énergie et moment",
      de: "Geschossenergie-Rechner - Mündungsenergie und Impuls",
      pt: "Calculadora de energia do projétil - energia e momento",
      ru: "Калькулятор энергии пули - энергия и импульс"
    },
    descriptions: {
      ...
      "zh-CN": "弹头能量计算器：输入弹头重量（格令）和初速（fps），即可立即得到枪口动能和动量。",
      "zh-TW": "彈頭能量計算器：輸入彈頭重量（格令）與初速（fps），即可立即得到槍口動能與動量。",
      ja: "弾頭重量（gr）と初速（fps）を入力すると、銃口エネルギーと運動量をすぐに算出します。",
      ko: "탄환 무게(grain)와 속도(fps)를 입력하면 총구 운동에너지와 운동량을 바로 계산합니다.",
      es: "Calculadora de energía de bala: introduce peso en grains y velocidad en fps para obtener al instante energía en boca y momento.",
      fr: "Calculateur d'énergie de balle : saisissez le poids en grains et la vitesse en fps pour obtenir instantanément l'énergie à la bouche et le moment.",
      de: "Geschossenergie-Rechner: Gewicht in Grains und Geschwindigkeit in fps eingeben und sofort Mündungsenergie und Impuls erhalten.",
      pt: "Calculadora de energia do projétil: informe o peso em grains e a velocidade em fps para obter energia na boca e momento instantaneamente.",
      ru: "Калькулятор энергии пули: введите вес в grains и скорость в fps, чтобы мгновенно получить дульную энергию и импульс."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "fu-li-ji-suan-qi",
      "zh-TW": "fu-li-ji-suan-qi",
      ja: "furyoku-keisanki",
      ko: "buyangnyeok-gyesangi",
      es: "calculadora-flotabilidad",
      fr: "calculateur-flottabilite",
      de: "auftrieb-rechner",
      pt: "calculadora-empuxo",
      ru: "kalkulyator-plavuchesti"
    },
    titles: {
      ...
      ja: "浮力計算機 - 浮力と浮沈条件",
      ko: "부력 계산기 - 부력과 부상 조건",
      es: "Calculadora de flotabilidad - Fuerza y condiciones",
      fr: "Calculateur de flottabilité - Poussée et équilibre",
      de: "Auftrieb-Rechner - Auftriebskraft und Schwimmen",
      pt: "Calculadora de empuxo - Força e flutuação",
      ru: "Калькулятор плавучести - Выталкивающая сила"
    },
    descriptions: {
      ...
      "zh-CN": "浮力计算器：根据阿基米德原理，结合质量、体积和流体密度，计算浮力、净力以及漂浮或下沉状态。",
      "zh-TW": "浮力計算器：依阿基米德原理，利用質量、體積與流體密度計算浮力、淨力，以及漂浮或下沉狀態。",
      ja: "浮力計算機：質量、体積、流体密度からアルキメデスの原理で浮力、正味の力、浮く・沈む条件を計算します。",
      ko: "부력 계산기: 질량, 부피, 유체 밀도로 아르키메데스 원리에 따라 부력, 순힘, 뜸 또는 가라앉음을 계산합니다.",
      es: "Calculadora de flotabilidad: calcula fuerza de empuje, fuerza neta y si un objeto flota o se hunde con masa, volumen y densidad.",
      fr: "Calculateur de flottabilité : calculez poussée d’Archimède, force nette et état de flottaison avec masse, volume et densité.",
      de: "Auftrieb-Rechner: Berechnen Sie Auftriebskraft, Nettokraft und ob ein Objekt schwimmt oder sinkt aus Masse, Volumen und Dichte.",
      pt: "Calculadora de empuxo: calcule força de empuxo, força líquida e se um objeto flutua ou afunda com massa, volume e densidade.",
      ru: "Калькулятор плавучести: рассчитайте выталкивающую силу, результирующую силу и будет ли объект плавать или тонуть."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "fuli-shiyan-jisuanqi",
      "zh-TW": "fuli-shiyan-jisuanqi",
      ja: "furyoku-jikken-keisanki",
      ko: "bullyeok-silheom-gyesangi",
      es: "calculadora-flotabilidad-experimento",
      fr: "calculatrice-flottabilite-experience",
      de: "auftrieb-experiment-rechner",
      pt: "calculadora-flutuabilidade-experimento",
      ru: "kalkulyator-plavuchesti-eksperimenta"
    },
    titles: {
      en: "Buoyancy Experiment Calculator – Float, Sink, or Neutral",
      "zh-CN": "浮力实验计算器：浮起、下沉或中性",
      "zh-TW": "浮力實驗計算器：浮起、下沉或中性",
      ja: "浮力実験計算機：浮く・沈む・中性",
      ko: "부력 실험 계산기: 뜨기, 가라앉기, 중성",
      es: "Calculadora de flotabilidad: flota, hunde o neutra",
      fr: "Calculateur de flottabilité : flotte, coule ou neutre",
      de: "Auftriebsrechner: schwimmt, sinkt oder neutral",
      pt: "Calculadora de flutuabilidade: flutua, afunda ou neutra",
      ru: "Калькулятор плавучести: всплывёт, утонет, нейтрально"
    },
    descriptions: {
      ...
      "zh-CN": "使用阿基米德原理计算浮力、物体密度，并预测物体在物理实验中的浮起、下沉或中性浮力表现。",
      "zh-TW": "運用阿基米德原理計算浮力、物體密度，並預測物體在物理實驗中的浮起、下沉或中性浮力表現。",
      ja: "アルキメデスの原理で浮力と物体密度を求め、実験で浮く・沈む・中性浮力を予測します。",
      ko: "아르키메데스 원리로 부력과 물체 밀도를 계산하고, 실험에서 뜨기·가라앉기·중성 부력을 예측합니다.",
      es: "Calcula el empuje y la densidad del objeto, y predice si flota, se hunde o queda en equilibrio usando el principio de Arquímedes.",
      fr: "Calculez la poussée d’Archimède et la densité de l’objet, puis prédisez s’il flotte, coule ou reste en équilibre.",
      de: "Berechnen Sie Auftrieb und Dichte des Objekts und sagen Sie mit dem archimedischen Prinzip voraus, ob es schwimmt, sinkt oder neutral bleibt.",
      pt: "Calcule o empuxo e a densidade do objeto e preveja se ele flutua, afunda ou fica em equilíbrio usando o princípio de Arquimedes.",
      ru: "Рассчитайте выталкивающую силу и плотность объекта и предскажите, всплывёт он, утонет или будет в нейтральной плавучести."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "reliang-jisuanqi",
      "zh-TW": "reliang-jisuanqi",
      ja: "netsuryou-keisanki",
      ko: "yeollyang-gyeongsan-gi",
      es: "calculadora-calorimetria",
      fr: "calculateur-calorimetrie",
      de: "kalorimetrie-rechner",
      pt: "calculadora-calorimetria",
      ru: "kalorimetricheskiy-kalkulyator"
    },
    titles: {
      en: "Calorimetry Calculator – Heat Energy & Temperature Change",
      "zh-CN": "量热计算器：热能与温度变化",
      "zh-TW": "量熱計算機：熱能與溫度變化",
      ja: "熱量計算機：熱エネルギーと温度変化",
      ko: "열량 계산기: 열에너지와 온도 변화",
      es: "Calculadora de calorimetría: energía y temperatura",
      fr: "Calculateur de calorimétrie : énergie et température",
      de: "Kalorimeter-Rechner: Wärmeenergie und Temperatur",
      pt: "Calculadora de calorimetria: energia e temperatura",
      ru: "Калькулятор калориметрии: тепло и температура"
    },
    descriptions: {
      ...
      "zh-CN": "量热计算器：使用 Q=mcΔT 计算热能，并可加入相变热。适用于化学实验、热力学和传热分析。",
      "zh-TW": "量熱計算機：使用 Q=mcΔT 計算熱能，並可加入相變熱。適用於化學實驗、熱力學與傳熱分析。",
      ja: "熱量計算機：Q=mcΔT による熱エネルギー計算と相変化熱の追加に対応。化学実験、熱力学、伝熱解析に最適です。",
      ko: "열량 계산기: Q=mcΔT로 열에너지를 계산하고 상변화 열도 포함할 수 있습니다. 화학 실험, 열역학, 열전달 분석에 적합합니다.",
      es: "Calculadora de calorimetría: calcula energía térmica con Q=mcΔT y calor de cambio de fase opcional. Útil en química y termodinámica.",
      fr: "Calculateur de calorimétrie : calcule l’énergie thermique avec Q=mcΔT et la chaleur de changement d’état en option. Idéal pour la chimie.",
      de: "Kalorimeter-Rechner: berechnet Wärmeenergie mit Q=mcΔT plus optionaler Phasenwechselwärme. Ideal für Chemie und Thermodynamik.",
      pt: "Calculadora de calorimetria: calcule energia térmica com Q=mcΔT e calor de mudança de fase opcional. Ideal para química e termodinâmica.",
      ru: "Калькулятор калориметрии: рассчитывает тепловую энергию по Q=mcΔT и учитывает теплоту фазового перехода. Подходит для химии и термодинамики."
    }
  },
  {
  ...
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "boyier-dinglv-jisuanqi",
      "zh-TW": "boyier-dinglu-jisuanqi",
      ja: "boiru-no-housoku-keisan",
      ko: "boil-beobchik-gyesangi",
      es: "calculadora-ley-boyle",
      fr: "calculateur-loi-boyle",
      de: "boyle-gesetz-rechner",
      pt: "calculadora-lei-boyle",
      ru: "kalkulyator-zakona-boylya"
    },
    titles: {
      en: "Boyle's Law Calculator – Gas Pressure and Volume",
      "zh-CN": "波义耳定律计算器：气体压力和体积",
      "zh-TW": "波以耳定律計算器：氣體壓力和體積",
      ja: "ボイルの法則計算機：気体の圧力と体積",
      ko: "보일 법칙 계산기: 기체 압력과 부피",
      es: "Calculadora de la ley de Boyle: presión y volumen",
      fr: "Calculateur de la loi de Boyle : pression et volume",
      de: "Boyle-Gesetz-Rechner: Druck und Volumen",
      pt: "Calculadora da lei de Boyle: pressão e volume",
      ru: "Калькулятор закона Бойля: давление и объем"
    },
    descriptions: {
      ...
      "zh-CN": "波义耳定律计算器：在恒温条件下解出 P₁V₁ = P₂V₂ 中未知的气体压力或体积，适用于化学和物理题目。",
      "zh-TW": "波以耳定律計算器：在恆溫條件下解出 P₁V₁ = P₂V₂ 中未知的氣體壓力或體積，適用於化學與物理題目。",
      ja: "ボイルの法則計算機：一定温度で P₁V₁ = P₂V₂ を使い、未知の気体の圧力や体積を求めます。化学・物理に最適です。",
      ko: "보일 법칙 계산기: 일정한 온도에서 P₁V₁ = P₂V₂를 이용해 기체 압력이나 부피를 구합니다. 화학·물리 문제에 적합합니다.",
      es: "Calculadora de la ley de Boyle: resuelve P₁V₁ = P₂V₂ para hallar presión o volumen a temperatura constante.",
      fr: "Calculateur de la loi de Boyle : résolvez P₁V₁ = P₂V₂ pour trouver la pression ou le volume à température constante.",
      de: "Boyle-Gesetz-Rechner: Lösen Sie P₁V₁ = P₂V₂ nach Druck oder Volumen bei konstanter Temperatur auf.",
      pt: "Calculadora da lei de Boyle: resolva P₁V₁ = P₂V₂ para encontrar pressão ou volume a temperatura constante.",
      ru: "Калькулятор закона Бойля: решите P₁V₁ = P₂V₂ для нахождения давления или объема при постоянной температуре."
    }
  },
  {
  ...
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "jiaodongli-jisuanqi",
      "zh-TW": "jiaodongli-jisuanqi",
      ja: "kaku-undo-ryo-keisanki",
      ko: "gak-undongnyang-gyesan-gi",
      es: "calculadora-momento-angular",
      fr: "calculateur-moment-cinetique",
      de: "drehimpuls-rechner",
      pt: "calculadora-momento-angular",
      ru: "moment-impulsa-kalkulyator"
    },
    titles: {
      ...
      ja: "角運動量計算機：質点と剛体",
      ko: "각운동량 계산기: 질점과 강체",
      es: "Calculadora de momento angular",
      fr: "Calculateur de moment cinétique",
      de: "Drehimpuls-Rechner",
      pt: "Calculadora de momento angular",
      ru: "Калькулятор момента импульса"
    },
    descriptions: {
      ...
      "zh-CN": "使用 L = mvr 计算质点角动量，或用 L = Iω 计算刚体角动量。适用于轨道力学、飞轮和旋转物体。",
      "zh-TW": "使用 L = mvr 計算質點角動量，或用 L = Iω 計算剛體角動量。適用於軌道力學、飛輪與旋轉物體。",
      ja: "点質量は L = mvr、剛体は L = Iω で角運動量を計算。軌道力学、フライホイール、回転体に対応。",
      ko: "질점은 L = mvr, 강체는 L = Iω로 각운동량을 계산합니다. 궤도역학, 플라이휠, 회전체에 적합합니다.",
      es: "Calcula el momento angular con L = mvr para una masa puntual o L = Iω para un cuerpo rígido. Útil en órbitas, volantes y rotación.",
      fr: "Calculez le moment cinétique avec L = mvr pour une masse ponctuelle ou L = Iω pour un solide. Idéal pour orbites, volants et rotation.",
      de: "Berechnen Sie den Drehimpuls mit L = mvr für eine Punktmasse oder L = Iω für einen starren Körper. Für Bahnen, Schwungräder und Rotation.",
      pt: "Calcule o momento angular com L = mvr para massa pontual ou L = Iω para corpo rígido. Ideal para órbitas, volantes e rotação.",
      ru: "Вычисляйте момент импульса по L = mvr для материальной точки или по L = Iω для твёрдого тела. Для орбит, маховиков и вращения."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "haibao-kongqi-yali-jisuanqi",
      "zh-TW": "haibao-kongqi-yali-jisuanqi",
      ja: "kodo-kuki-atsuryoku-keisan",
      ko: "godo-giap-gyesan",
      es: "calculadora-presion-aire-altitud",
      fr: "calculateur-pression-air-altitude",
      de: "luftdruck-hoehe-rechner",
      pt: "calculadora-pressao-do-ar-em-altitude",
      ru: "raschet-davleniya-vozdukha-na-vysote"
    },
    titles: {
      en: "Air Pressure at Altitude Calculator",
      "zh-CN": "海拔空气压力计算器",
      ...
      ja: "高度の気圧計算機",
      ko: "고도 기압 계산기",
      es: "Calculadora de presión del aire en altura",
      fr: "Calculateur de pression de l'air en altitude",
      de: "Luftdruck in der Höhe Rechner",
      pt: "Calculadora de pressão do ar em altitude",
      ru: "Калькулятор давления воздуха на высоте"
    },
    descriptions: {
      ...
      "zh-CN": "海拔空气压力计算器：使用气压公式和 ISA 模型计算大气压力、温度、空气密度和密度高度。",
      "zh-TW": "海拔空氣壓力計算器：使用氣壓公式與 ISA 模型計算大氣壓力、溫度、空氣密度與密度高度。",
      ja: "高度の気圧計算機：気圧公式と ISA モデルで大気圧、温度、空気密度、密度高度を計算します。",
      ko: "고도 기압 계산기: 기압 공식과 ISA 모델로 대기압, 온도, 공기 밀도, 밀도고도를 계산합니다.",
      es: "Calculadora de presión del aire en altura: calcula presión atmosférica, temperatura, densidad y altitud de densidad con la fórmula barométrica y el ISA.",
      fr: "Calculateur de pression de l'air en altitude : calculez pression, température, densité et altitude densité avec la formule barométrique et l'ISA.",
      de: "Luftdruck in der Höhe Rechner: Berechnet Luftdruck, Temperatur, Luftdichte und Dichtehöhe mit der barometrischen Formel und dem ISA-Modell.",
      pt: "Calculadora de pressão do ar em altitude: calcule pressão atmosférica, temperatura, densidade do ar e altitude de densidade com a fórmula barométrica e o ISA.",
      ru: "Калькулятор давления воздуха на высоте: рассчитывает давление, температуру, плотность воздуха и плотностную высоту по ISA."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "aerfen-sudu-jisuanqi",
      "zh-TW": "aerfen-sudu-jisuanqi",
      ja: "arufen-sokudo-keisanki",
      ko: "alpen-sokdo-gyesangi",
      es: "calculadora-velocidad-alfven",
      fr: "calculateur-vitesse-alfven",
      de: "alfven-geschwindigkeit-rechner",
      pt: "calculadora-velocidade-alfven",
      ru: "kalkulyator-skorosti-alfvena"
    },
    titles: {
      ...
      ja: "アルヴェーン速度計算機",
      ko: "알펜 속도 계산기",
      es: "Calculadora de velocidad de Alfvén",
      fr: "Calculateur de vitesse d’Alfvén",
      de: "Alfvén-Geschwindigkeit Rechner",
      pt: "Calculadora de velocidade de Alfvén",
      ru: "Калькулятор скорости Альвена"
    },
    descriptions: {
      ...
      "zh-CN": "阿尔芬速度计算器：根据磁场强度、离子密度和离子质量，用公式 v_A = B / √(μ₀ ρ) 计算等离子体中的 MHD 波速。",
      "zh-TW": "阿爾芬速度計算器：依磁場強度、離子密度與離子質量，用公式 v_A = B / √(μ₀ ρ) 計算電漿中的 MHD 波速。",
      ja: "磁場強度、イオン密度、イオン質量から、v_A = B / √(μ₀ ρ) でプラズマ中の MHD 波速（アルヴェーン速度）を計算します。",
      ko: "알펜 속도 계산기: 자기장 세기, 이온 밀도, 이온 질량으로 v_A = B / √(μ₀ ρ)를 사용해 플라스마의 MHD 파동 속도를 계산합니다.",
      es: "Calcula la velocidad de Alfvén en plasma a partir del campo magnético, la densidad iónica y la masa iónica con v_A = B / √(μ₀ ρ).",
      fr: "Calculez la vitesse d’Alfvén dans un plasma à partir du champ magnétique, de la densité ionique et de la masse ionique avec v_A = B / √(μ₀ ρ).",
      de: "Berechne die Alfvén-Geschwindigkeit im Plasma aus Magnetfeldstärke, Ionendichte und Ionenmasse mit v_A = B / √(μ₀ ρ).",
      pt: "Calcule a velocidade de Alfvén no plasma pelo campo magnético, densidade de íons e massa iônica usando v_A = B / √(μ₀ ρ).",
      ru: "Рассчитайте скорость Альвена в плазме по магнитному полю, плотности ионов и массе иона по формуле v_A = B / √(μ₀ ρ)."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "waixing-wenming-jisuanqi-delake-fangcheng",
      "zh-TW": "waixing-wenming-jisuanqi-delake-fangcheng",
      ja: "uchujin-bunmei-keisanki-doreiku-hoteishiki",
      ko: "oegye-munmyeong-gyesangi-deureikeu-bangjeongsik",
      es: "calculadora-civilizaciones-extraterrestres-ecuacion-drake",
      fr: "calculateur-civilisations-extraterrestres-equation-drake",
      de: "ausserirdische-zivilisationen-rechner-drake-gleichung",
      pt: "calculadora-civilizacoes-alienigenas-equacao-drake",
      ru: "kalkulyator-inoplanetnyh-civilizaciy-uravnenie-dreyka"
    },
    titles: {
      ...
      "zh-TW": "外星文明計算器 - 德雷克方程",
      ja: "宇宙人文明計算機 - ドレイク方程式",
      ko: "외계 문명 계산기 - 드레이크 방정식",
      es: "Calculadora de civilizaciones extraterrestres",
      fr: "Calculateur de civilisations extraterrestres",
      de: "Rechner für außerirdische Zivilisationen",
      pt: "Calculadora de civilizações alienígenas",
      ru: "Калькулятор инопланетных цивилизаций"
    },
    descriptions: {
      ...
      "zh-CN": "德雷克方程计算器：用恒星形成率、行星比例、生命概率和文明寿命估算银河系文明数量。",
      "zh-TW": "德雷克方程計算器：用恆星形成率、行星比例、生命機率與文明壽命估算銀河系文明數量。",
      ja: "ドレイク方程式計算機：星形成率、惑星比率、生命の確率、文明寿命から銀河系の文明数を推定します。",
      ko: "드레이크 방정식 계산기: 별 형성률, 행성 비율, 생명 발생 확률, 문명 수명으로 우리은하 문명 수를 추정합니다.",
      es: "Calculadora de la ecuación de Drake: estima civilizaciones en la Vía Láctea con tasa estelar, planetas, vida y duración civilizatoria.",
      fr: "Calculateur de l'équation de Drake : estimez les civilisations de la Voie lactée avec formation stellaire, planètes, vie et durée.",
      de: "Drake-Gleichung-Rechner: Schätze Zivilisationen in der Milchstraße mit Sternentstehung, Planetenanteilen, Lebenswahrscheinlichkeit und Lebensdauer.",
      pt: "Calculadora da equação de Drake: estime civilizações na Via Láctea com formação estelar, planetas, probabilidade de vida e duração.",
      ru: "Калькулятор уравнения Дрейка: оцените цивилизации Млечного Пути по скорости звездообразования, планетам, вероятности жизни и сроку цивилизаций."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "qingxie-wandao-jisuanqi",
      "zh-TW": "qingxie-wandao-jisuanqi",
      ja: "banku-kaku-keisanki",
      ko: "baengkeu-gak-gyesangi",
      es: "angulo-de-peralte-calculadora",
      fr: "angle-devers-calculateur",
      de: "ueberhoehungswinkel-rechner",
      pt: "angulo-superelevacao-calculadora",
      ru: "ugol-virazha-kalkulyator"
    },
    titles: {
      ...
      ja: "バンク角計算機 – バンク曲線設計",
      ko: "뱅크각 계산기 – 뱅크 곡선 설계",
      es: "Calculadora de ángulo de peralte",
      fr: "Calculateur d’angle de dévers",
      de: "Überhöhungswinkel-Rechner",
      pt: "Calculadora de ângulo de superelevação",
      ru: "Калькулятор угла виража"
    },
    descriptions: {
      ...
      "zh-CN": "倾斜弯道计算器：用 tan(θ) = v²/(rg) 求倾角、安全速度或曲线半径，适用于道路、赛道和铁路。",
      "zh-TW": "傾斜彎道計算器：用 tan(θ) = v²/(rg) 求傾角、安全速度或曲線半徑，適用於道路、賽道與鐵路。",
      ja: "バンク角計算機: tan(θ) = v²/(rg) でバンク角、安全速度、曲線半径を求めます。道路、競馬場、鉄道、ベロドロームに対応。",
      ko: "뱅크각 계산기: tan(θ) = v²/(rg)로 뱅크각, 안전 속도, 곡선 반지름을 구합니다. 도로, 경주로, 철도, 벨로드롬에 사용합니다.",
      es: "Calcula el ángulo de peralte, la velocidad segura o el radio de curva con tan(θ) = v²/(rg). Para carreteras, pistas y ferrocarriles.",
      fr: "Calculez l’angle de dévers, la vitesse de sécurité ou le rayon d’une courbe avec tan(θ) = v²/(rg). Pour routes, circuits et voies ferrées.",
      de: "Überhöhungswinkel berechnen: tan(θ) = v²/(rg) für sicheren Speed oder Kurvenradius. Für Straßen, Rennstrecken und Eisenbahnen.",
      pt: "Calcule o ângulo de superelevação, a velocidade segura ou o raio da curva com tan(θ) = v²/(rg). Para estradas, pistas e ferrovias.",
      ru: "Калькулятор угла виража: tan(θ) = v²/(rg) для безопасной скорости или радиуса. Для дорог, трасс, железных дорог и велодромов."
    }
  },
  {
  ...
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "jiasudu-jisuanqi",
      "zh-TW": "jia-su-du-ji-suan-qi",
      ja: "kasokudo-keisanki",
      ko: "gasokdo-gyesangi",
      es: "calculadora-aceleracion",
      fr: "calculateur-acceleration",
      de: "beschleunigungsrechner",
      pt: "calculadora-aceleracao",
      ru: "kalkulyator-uskoreniya"
    },
    titles: {
      en: "Acceleration Calculator – Compute Rate of Velocity Change",
      "zh-CN": "加速度计算器 - 计算速度变化率",
      "zh-TW": "加速度計算器 - 計算速度變化率",
      ja: "加速度計算機 - 速度変化率を計算",
      ko: "가속도 계산기 - 속도 변화율 계산",
      es: "Calculadora de aceleración - cambio de velocidad",
      fr: "Calculateur d’accélération - variation de vitesse",
      de: "Beschleunigungsrechner - Geschwindigkeitsänderung",
      pt: "Calculadora de aceleração - variação de velocidade",
      ru: "Калькулятор ускорения - изменение скорости"
    },
    descriptions: {
      ...
      "zh-CN": "加速度计算器：输入初速度、末速度和时间，计算 m/s² 与 g 值。支持 m/s、km/h、mph 和 ft/s。",
      "zh-TW": "加速度計算器：輸入初速度、末速度與時間，計算 m/s² 與 g 值。支援 m/s、km/h、mph、ft/s。",
      ja: "加速度計算機：初速度、終速度、時間を入力し、m/s² と g 単位で加速度を計算。m/s、km/h、mph、ft/s 対応。",
      ko: "가속도 계산기: 초기 속도, 최종 속도, 시간을 입력해 m/s² 및 g 단위 가속도를 계산합니다. m/s, km/h, mph, ft/s 지원.",
      es: "Calculadora de aceleración: introduce velocidad inicial, final y tiempo para calcular m/s² y unidades g. Admite m/s, km/h, mph y ft/s.",
      fr: "Calculateur d’accélération : saisissez vitesse initiale, finale et temps pour calculer en m/s² et en g. Prend en charge m/s, km/h, mph, ft/s.",
      de: "Beschleunigungsrechner: Anfangs- und Endgeschwindigkeit sowie Zeit eingeben und m/s² sowie g-Werte berechnen. Unterstützt m/s, km/h, mph, ft/s.",
      pt: "Calculadora de aceleração: informe velocidade inicial, final e tempo para calcular em m/s² e unidades g. Suporta m/s, km/h, mph e ft/s.",
      ru: "Калькулятор ускорения: введите начальную и конечную скорость и время, чтобы рассчитать m/s² и g. Поддерживает m/s, km/h, mph, ft/s."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "dianchang-jiasu-jisuanqi",
      "zh-TW": "dianchang-jiasu-jisuanqi",
      ja: "denba-kasoku-keisanki",
      ko: "jeonjang-gasok-gyesan-gi",
      es: "calculadora-aceleracion-campo-electrico",
      fr: "calculateur-acceleration-champ-electrique",
      de: "elektrische-feld-beschleunigungsrechner",
      pt: "calculadora-aceleracao-campo-eletrico",
      ru: "kalkulyator-uskoreniya-v-elektricheskom-pole"
    },
    titles: {
      en: "Electric Field Particle Acceleration Calculator",
      "zh-CN": "电场加速计算器 – 带电粒子运动",
      "zh-TW": "電場加速計算器 – 帶電粒子運動",
      ja: "電場加速計算機 – 荷電粒子の運動",
      ko: "전기장 가속 계산기 – 하전 입자 운동",
      es: "Calculadora de aceleración en campo eléctrico",
      fr: "Calculateur d’accélération en champ électrique",
      de: "Rechner für elektrische Feldbeschleunigung",
      pt: "Calculadora de aceleração em campo elétrico",
      ru: "Калькулятор ускорения в электрическом поле"
    },
    descriptions: {
      ...
      "zh-CN": "计算带电粒子在电场中的受力、加速度、末速度和动能，适用于电子、质子和离子。",
      "zh-TW": "計算帶電粒子在電場中的受力、加速度、末速度與動能，適用於電子、質子與離子。",
      ja: "電場中の荷電粒子について、力・加速度・終速度・運動エネルギーを電子、陽子、イオン向けに計算します。",
      ko: "전기장 속 하전 입자의 힘, 가속도, 최종 속도, 운동 에너지를 전자·양성자·이온 기준으로 계산합니다.",
      es: "Calcula fuerza, aceleración, velocidad final y energía cinética de partículas cargadas en un campo eléctrico.",
      fr: "Calcule la force, l’accélération, la vitesse finale et l’énergie cinétique de particules chargées dans un champ électrique.",
      de: "Berechnet Kraft, Beschleunigung, Endgeschwindigkeit und kinetische Energie geladener Teilchen im elektrischen Feld.",
      pt: "Calcula força, aceleração, velocidade final e energia cinética de partículas carregadas em campo elétrico.",
      ru: "Вычисляет силу, ускорение, конечную скорость и кинетическую энергию заряженных частиц в электрическом поле."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "sheng-zu-kang-ji-suan-qi-fan-she-yu-tou-she",
      "zh-TW": "sheng-zu-kang-ji-suan-qi-fan-she-yu-tou-she",
      ja: "onkyou-impedansu-keisanki-hansha-tousha-keisuu",
      ko: "eumhyang-impedeonseu-gyesan-gi-bansa-tugae-gyesu",
      es: "calculadora-impedancia-acustica-reflexion-transmision",
      fr: "calculateur-impedance-acoustique-reflexion-transmission",
      de: "akustische-impedanz-reflexion-transmission",
      pt: "calculadora-impedancia-acustica-reflexao-transmissao",
      ru: "akusticheskiy-impedans-otrazhenie-prokhozhdenie"
    },
    titles: {
      en: "Acoustic Impedance Calculator – Reflection & Transmission",
      "zh-CN": "声阻抗计算器：反射与透射系数",
      "zh-TW": "聲阻抗計算器：反射與透射係數",
      ja: "音響インピーダンス計算機：反射と透過係数",
      ko: "음향 임피던스 계산기: 반사와 투과 계수",
      es: "Impedancia acústica: reflexión y transmisión",
      fr: "Impédance acoustique : réflexion et transmission",
      de: "Akustische Impedanz: Reflexion und Transmission",
      pt: "Impedância acústica: reflexão e transmissão",
      ru: "Акустический импеданс: отражение и прохождение"
    },
    descriptions: {
      ...
      "zh-CN": "计算声阻抗 Z=ρc，并求出声波在两种介质边界处的反射、透射系数和强度百分比。",
      "zh-TW": "計算聲阻抗 Z=ρc，並求出聲波在兩種介質邊界處的反射、透射係數與強度百分比。",
      ja: "音響インピーダンス Z=ρc を計算し、境界面での反射・透過係数と強度比を求めます。",
      ko: "음향 임피던스 Z=ρc를 계산하고, 경계면에서의 반사·투과 계수와 강도 비율을 구합니다.",
      es: "Calcula la impedancia acústica Z=ρc y los coeficientes de reflexión, transmisión y porcentajes de intensidad entre dos medios.",
      fr: "Calculez l’impédance acoustique Z=ρc, ainsi que les coefficients de réflexion, de transmission et les pourcentages d’intensité.",
      de: "Berechnen Sie die akustische Impedanz Z=ρc sowie Reflexions-, Transmissions- und Intensitätsanteile an Grenzflächen.",
      pt: "Calcule a impedância acústica Z=ρc e os coeficientes de reflexão, transmissão e percentuais de intensidade em uma fronteira entre meios.",
      ru: "Рассчитайте акустический импеданс Z=ρc, а также коэффициенты отражения, прохождения и доли интенсивности на границе сред."
    }
  },
  {
