...
export const tools: ToolEntry[] = [
  ...
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "duoxiangshi-hezi-fa",
      "zh-TW": "duoxiangshi-hezi-fa",
      ja: "takoushiki-bokkusu-ho",
      ko: "dahangsik-sangjabeop",
      es: "multiplicacion-polinomios-caja",
      fr: "multiplication-polynomes-tableau",
      de: "polynom-boxmethode",
      pt: "multiplicacao-polinomios-caixa",
      ru: "metod-tablitsy-mnogochlenov"
    },
    titles: {
      ...
      ja: "多項式ボックス法計算機",
      ko: "다항식 상자법 계산기",
      es: "Multiplicación de polinomios por caja",
      fr: "Multiplication de polynômes par tableau",
      de: "Polynom-Boxmethode",
      pt: "Multiplicação de polinômios por caixa",
      ru: "Многочлены: метод таблицы"
    },
    descriptions: {
      ...
      "zh-CN": "用盒式法可视化乘法，立即查看完整乘法表和化简结果。",
      "zh-TW": "用盒式法視覺化乘法，立即查看完整乘法表與化簡結果。",
      ja: "ボックス法で多項式を視覚的に掛け算し、展開表と簡約結果をすぐ確認できます。",
      ko: "상자법으로 다항식을 시각적으로 곱하고, 전체 표와 간단한 결과를 바로 확인하세요.",
      es: "Multiplica polinomios visualmente con el método de la caja y ve la tabla completa y el producto simplificado.",
      fr: "Multipliez des polynômes visuellement avec la méthode du tableau et voyez la grille complète et le produit simplifié.",
      de: "Multipliziere Polynome visuell mit der Boxmethode und sieh die komplette Tabelle sowie das vereinfachte Ergebnis.",
      pt: "Multiplique polinômios visualmente com o método da caixa e veja a tabela completa e o produto simplificado.",
      ru: "Визуально умножайте многочлены методом таблицы и сразу смотрите полную сетку и упрощённый результат."
    }
  },
  {
    ...
    titles: {
      ...
      "zh-CN": "最大公因数计算器 - 多个数字的GCF",
      "zh-TW": "最大公因數計算器 - 多個數字的GCF",
      ja: "最大公約数計算機 - 数値のGCF",
    ...
    descriptions: {
      ...
      "zh-CN": "使用欧几里得算法或质因数分解计算两个或多个整数的最大公因数(GCF)，并显示分步过程，便于学习。",
      "zh-TW": "使用歐幾里得演算法或質因數分解計算兩個或多個整數的最大公因數(GCF)，並顯示逐步過程，方便學習。",
      ja: "ユークリッドの互除法または素因数分解で、2つ以上の整数の最大公約数(GCF)を計算。学習に役立つ手順も表示します。",
      ko: "유클리드 알고리즘 또는 소인수분해로 두 개 이상의 정수의 최대공약수(GCF)를 계산하고 학습용 단계별 풀이를 보여줍니다.",
      es: "Calcula el máximo común divisor (MCD) de dos o más enteros con el algoritmo de Euclides o factorización prima, con pasos detallados.",
      ...
      de: "Berechne den größten gemeinsamen Teiler (GGT) von zwei oder mehr ganzen Zahlen mit euklidischem Algorithmus oder Primfaktorzerlegung, inklusive Rechenschritten.",
      pt: "Calcule o máximo divisor comum (MDC) de dois ou mais inteiros com o algoritmo de Euclides ou fatoração prima, com passo a passo.",
      ru: "Вычисляйте НОД двух и более целых чисел алгоритмом Евклида или разложением на простые множители, с пошаговым решением."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "gcf-lcm-jisuanqi",
      "zh-TW": "gcf-lcm-jisuanqi",
      ja: "gcf-lcm-keisanki",
      ko: "gcf-lcm-gyesangi",
      es: "calculadora-mcd-mcm",
      fr: "calculatrice-pgcd-ppcm",
      de: "ggt-kgv-rechner",
      pt: "calculadora-mdc-mmcm",
    ...
    descriptions: {
      ...
      "zh-CN": "快速计算任意一组数字的最大公因数和最小公倍数，支持欧几里得算法和两个以上正整数。",
      "zh-TW": "快速計算任意一組數字的最大公因數和最小公倍數，支援歐幾里得演算法與兩個以上正整數。",
      ja: "任意の数列の最大公約数と最小公倍数をすぐに計算。ユークリッドの互除法に対応し、2個以上の正の整数に対応します。",
      ko: "임의의 수열에서 최대공약수와 최소공배수를 즉시 계산합니다. 유클리드 알고리즘을 사용하며 두 개 이상의 양의 정수를 지원합니다.",
      ...
      fr: "Calculez instantanément le PGCD et le PPCM de n'importe quel ensemble de nombres. Utilise l'algorithme d'Euclide et prend en charge deux entiers positifs ou plus.",
      de: "Berechnen Sie sofort den GGT und das KGV beliebiger Zahlen. Nutzt den euklidischen Algorithmus und unterstützt zwei oder mehr positive ganze Zahlen.",
      pt: "Calcule instantaneamente o MDC e o MMC de qualquer conjunto de números. Usa o algoritmo de Euclides e suporta dois ou mais inteiros positivos.",
      ru: "Мгновенно вычисляйте НОД и НОК любого набора чисел. Использует алгоритм Евклида и поддерживает два и более положительных целых числа."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "gaosi-yuedan-xiaoyuan-ji",
      "zh-TW": "gaosi-yuedan-xiaoyuan-ji",
      ja: "gausu-jordan-shokyo-keisanki",
      ko: "gauseu-jordan-sogeobeop-gyesangi",
      es: "calculadora-eliminacion-gauss-jordan",
      fr: "calculateur-elimination-gauss-jordan",
      de: "gauss-jordan-elimination-rechner",
      pt: "calculadora-eliminacao-gauss-jordan",
      ru: "kalkulyator-metoda-gaussa-jordana"
    },
    titles: {
      en: "Gauss-Jordan Elimination Calculator - Solve Linear Systems",
      "zh-CN": "高斯-约旦消元计算器 - 求解线性方程组",
      "zh-TW": "高斯-喬丹消去法計算器 - 求解線性方程組",
      ja: "ガウス・ジョルダン消去法計算機 - 連立一次方程式を解く",
      ko: "가우스-조르당 소거법 계산기 - 선형 연립방정식 풀이",
      es: "Calculadora de eliminación Gauss-Jordan",
      fr: "Calculateur d’élimination de Gauss-Jordan",
      de: "Gauß-Jordan-Eliminationsrechner",
      pt: "Calculadora de eliminação de Gauss-Jordan",
      ru: "Калькулятор метода Гаусса-Жордана"
    },
    descriptions: {
      ...
      "zh-CN": "使用高斯-约旦消元法求解线性方程组。输入增广矩阵，获得 RREF 和精确解。",
      "zh-TW": "使用高斯-喬丹消去法求解線性方程組。輸入增廣矩陣，取得 RREF 與精確解。",
      ja: "ガウス・ジョルダン消去法で連立一次方程式を解きます。拡大係数行列を入力して、RREF と厳密解を取得できます。",
      ko: "가우스-조르당 소거법으로 선형 연립방정식을 풉니다. 첨가행렬을 입력해 RREF와 정확한 해를 확인하세요.",
      es: "Resuelve sistemas de ecuaciones lineales con eliminación Gauss-Jordan. Introduce la matriz aumentada y obtén la RREF y la solución exacta.",
      fr: "Résolvez des systèmes d’équations linéaires par élimination de Gauss-Jordan. Saisissez la matrice augmentée pour obtenir la RREF et la solution exacte.",
      de: "Löse lineare Gleichungssysteme mit der Gauß-Jordan-Elimination. Gib die erweiterte Matrix ein und erhalte RREF und exakte Lösung.",
      pt: "Resolva sistemas de equações lineares com eliminação de Gauss-Jordan. Insira a matriz aumentada e obtenha a RREF e a solução exata.",
      ru: "Решайте системы линейных уравнений методом Гаусса-Жордана. Введите расширенную матрицу и получите RREF и точное решение."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-TW": "gamma-han-shu-ji-suan-qi",
      ja: "gamma-kansu-keisan-ki",
      ...
      ru: "kalkulyator-funkcii-gamma"
    },
    titles: {
      en: "Gamma Function Calculator - Compute Γ(z) Online",
      "zh-CN": "Gamma函数计算器 - 在线计算Γ(z)",
      "zh-TW": "Gamma函數計算器 - 線上計算Γ(z)",
      ja: "ガンマ関数計算機 - Γ(z)をオンライン計算",
      ko: "감마 함수 계산기 - Γ(z) 온라인 계산",
      es: "Calculadora de la función Gamma - Γ(z) online",
      fr: "Calculateur de la fonction Gamma - Γ(z) en ligne",
      de: "Gamma-Funktionsrechner - Γ(z) online berechnen",
      pt: "Calculadora da função Gama - Γ(z) online",
      ru: "Калькулятор функции Гамма - Γ(z) онлайн"
    },
    descriptions: {
      ...
      "zh-CN": "使用Lanczos近似计算任意实数的Gamma函数Γ(z)。可即时求解阶乘、积分与特殊函数。",
      "zh-TW": "使用Lanczos近似計算任意實數的Gamma函數Γ(z)。可即時求得階乘、積分與特殊函數。",
      ja: "Lanczos近似で任意の実数のガンマ関数Γ(z)を計算。階乗、積分、特殊関数にすばやく対応。",
      ko: "Lanczos 근사로 임의의 실수에 대한 감마 함수 Γ(z)를 계산합니다. 계승, 적분, 특수함수에 즉시 활용하세요.",
      ...
      fr: "Calculez la fonction Gamma Γ(z) pour tout nombre réel avec l’approximation de Lanczos. Résultats instantanés pour factorielles et intégrales.",
      de: "Berechnen Sie die Gamma-Funktion Γ(z) für jede reelle Zahl mit der Lanczos-Approximation. Sofortergebnisse für Fakultäten und Integrale.",
      pt: "Calcule a função Gama Γ(z) para qualquer número real usando a aproximação de Lanczos. Resultados instantâneos para fatoriais e integrais.",
      ru: "Вычисляйте функцию Гамма Γ(z) для любого вещественного числа с помощью аппроксимации Ланцоша. Мгновенные результаты для факториалов и интегралов."
    }
  }
];
