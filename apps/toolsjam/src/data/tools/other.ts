...
export const tools: ToolEntry[] = [
  ...
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "tuopan-jisuanqi",
      "zh-TW": "tuopan-jisuanqi",
      ja: "paretto-keisanki",
      ko: "pallet-gyesangi",
      es: "calculadora-pallets",
      fr: "calculateur-palettes",
      de: "palettenrechner",
      pt: "calculadora-paletes",
      ru: "kalkulyator-poddonov"
    },
    titles: {
      en: "Pallet Calculator - Boxes, Layers & Weight Capacity",
      "zh-CN": "托盘计算器 - 箱数、层数与承重",
      "zh-TW": "棧板計算器 - 箱數、層數與承重",
      ja: "パレット計算機 - 箱数・段数・耐荷重",
      ko: "팔레트 계산기 - 박스 수, 적재 층수, 하중",
      es: "Calculadora de pallets - Cajas, capas y peso",
      fr: "Calculateur de palettes - Cartons, couches et poids",
      de: "Palettenrechner - Kartons, Lagen und Traglast",
      pt: "Calculadora de paletes - Caixas, camadas e peso",
      ru: "Калькулятор поддонов - Коробки, ярусы и вес"
    },
    descriptions: {
      ...
      "zh-CN": "计算每个托盘可装箱数、堆叠层数、总重量和空间利用率，优化物流仓储中的托盘装载与运输效率。",
      "zh-TW": "計算每個棧板可裝箱數、堆疊層數、總重量與空間利用率，最佳化物流倉儲的棧板裝載效率。",
      ja: "物流・倉庫向けに、パレットあたりの箱数、積み重ね段数、総重量、スペース利用率を計算し、積載効率を最適化します。",
      ko: "물류와 창고 운영을 위해 팔레트당 박스 수, 적재 층수, 총중량, 공간 활용률을 계산하고 적재 효율을 최적화하세요.",
      es: "Calcula cajas por pallet, capas de apilado, peso total y uso del espacio para logística y almacenes. Optimiza la carga para envíos.",
      fr: "Calculez cartons par palette, couches d'empilage, poids total et utilisation de l'espace pour optimiser la logistique et l'entreposage.",
      de: "Berechne Kartons pro Palette, Stapellagen, Gesamtgewicht und Raumnutzung für Logistik und Lager. Optimiere die Palettenbeladung.",
      pt: "Calcule caixas por palete, camadas de empilhamento, peso total e uso do espaço para logística e armazenagem. Otimize o carregamento.",
      ru: "Рассчитайте коробки на поддон, ярусы штабелирования, общий вес и использование пространства для логистики и склада."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "qijiou-jianyan-qi",
      "zh-TW": "qijiou-jianyan-qi",
      ja: "pariti-bitto-keisan-ki",
      ko: "paeliti-biteu-gyesangi",
      es: "calculadora-bit-paridad",
      fr: "calculateur-bit-parite",
      de: "paritaetsbit-rechner",
      pt: "calculadora-bit-paridade",
      ru: "kalkulyator-bita-pariteta"
    },
    titles: {
      ...
      ja: "パリティビット計算機",
      ko: "패리티 비트 계산기",
      es: "Calculadora de bit de paridad",
      fr: "Calculateur de bit de parité",
      de: "Paritätsbit-Rechner",
      pt: "Calculadora de bit de paridade",
      ru: "Калькулятор бита паритета"
    },
    descriptions: {
      ...
      "zh-CN": "计算二进制数据的偶校验或奇校验位，生成传输字符串，验证接收数据并检测单比特错误。",
      "zh-TW": "計算二進位資料的偶校驗或奇校驗位，產生傳輸字串，驗證接收資料並偵測單位元錯誤。",
      ja: "2進データの偶数・奇数パリティを計算し、送信文字列を生成、受信データを検証して単一ビットエラーを検出します。",
      ko: "2진 데이터의 짝수/홀수 패리티 비트를 계산하고, 전송 문자열을 생성하며, 수신 데이터를 검증해 단일 비트 오류를 찾습니다.",
      es: "Calcula bits de paridad par o impar para datos binarios, genera la cadena de transmisión y valida datos recibidos para detectar errores de un bit.",
      fr: "Calculez les bits de parité paire ou impaire pour des données binaires, générez la chaîne de transmission et validez les données reçues.",
      de: "Berechnen Sie gerade oder ungerade Paritätsbits für Binärdaten, erzeugen Sie Übertragungsstrings und prüfen Sie empfangene Daten.",
      pt: "Calcule bits de paridade par ou ímpar para dados binários, gere a string de transmissão e valide dados recebidos.",
      ru: "Вычисляйте биты чётности для бинарных данных, создавайте строку передачи и проверяйте полученные данные на одиночные ошибки."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "nanowrimo-xiezuo-jindu-jisuanqi",
      "zh-TW": "nanowrimo-xiezuo-jindu-jisuanqi",
      ja: "nanowrimo-sakubun-shinkou-keisanki",
      ko: "nanowrimo-seojeong-jinheung-gyesan-gi",
      es: "calculadora-progreso-nanowrimo",
      fr: "calculateur-progression-nanowrimo",
      de: "nanowrimo-schreibfortschritt-rechner",
      pt: "calculadora-progresso-nanowrimo",
      ru: "nanowrimo-schetchik-progresa"
    },
    titles: {
      en: "NaNoWriMo Calculator - Track Novel Writing Progress",
      "zh-CN": "NaNoWriMo写作进度计算器",
      "zh-TW": "NaNoWriMo寫作進度計算器",
      ja: "NaNoWriMo執筆進捗計算機",
      ko: "NaNoWriMo 집필 진행 계산기",
      es: "Calculadora de progreso NaNoWriMo",
      fr: "Calculateur de progression NaNoWriMo",
      de: "NaNoWriMo-Schreibfortschritt-Rechner",
      pt: "Calculadora de progresso NaNoWriMo",
      ru: "Калькулятор прогресса NaNoWriMo"
    },
    descriptions: {
      ...
      "zh-CN": "计算每日字数目标，跟踪NaNoWriMo进度，并估算你的50,000字小说挑战完成日期。",
      "zh-TW": "計算每日字數目標，追蹤NaNoWriMo進度，並估算你的50,000字小說挑戰完成日期。",
      ja: "1日あたりの目標語数を計算し、NaNoWriMoの進捗を追跡し、5万語小説チャレンジの完了日を見積もります。",
      ko: "일일 목표 글자 수를 계산하고 NaNoWriMo 진행률을 추적하며 5만 단어 소설 도전의 완료일을 예상합니다.",
      es: "Calcula tu objetivo diario, sigue tu progreso en NaNoWriMo y estima la fecha de finalización de tu novela de 50.000 palabras.",
      fr: "Calculez votre objectif quotidien, suivez votre progression NaNoWriMo et estimez la date de fin de votre roman de 50 000 mots.",
      de: "Berechnen Sie Ihr tägliches Wortziel, verfolgen Sie Ihren NaNoWriMo-Fortschritt und schätzen Sie das Enddatum Ihres 50.000-Wörter-Romans.",
      pt: "Calcule sua meta diária, acompanhe seu progresso no NaNoWriMo e estime a data de conclusão do seu romance de 50.000 palavras.",
      ru: "Рассчитайте ежедневную норму слов, отслеживайте прогресс NaNoWriMo и узнайте дату завершения романа на 50 000 слов."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "di-yu-men-zuo-biao-ji-suan-qi",
      "zh-TW": "di-yu-men-zuo-biao-ji-suan-qi",
      ja: "neta-potalu-zahyo-keisanki",
      ko: "nedeo-potal-jwapyo-gyesangi",
      es: "calculadora-portal-nether-coordenadas",
      fr: "calculateur-portail-nether-coordonnees",
      de: "netherportal-koordinaten-rechner",
      pt: "calculadora-portal-nether-coordenadas",
      ru: "kalkulyator-koordinat-portala-v-nezer"
    },
    titles: {
      ...
      ja: "ネザーポータル座標計算機",
      ko: "네더 포털 좌표 계산기",
      es: "Calculadora de portal del Nether",
      fr: "Calculateur de portail du Nether",
      de: "Netherportal-Koordinatenrechner",
      pt: "Calculadora de portal do Nether",
      ru: "Калькулятор координат портала в Незер"
    },
    descriptions: {
      ...
      "zh-CN": "计算下界传送门坐标，按 8:1 比例转换主世界与下界坐标，并计算任意尺寸所需黑曜石。",
      "zh-TW": "計算地獄傳送門座標，依 8:1 比例轉換主世界與地獄座標，並計算任意尺寸所需黑曜石。",
      ja: "ネザーポータル座標を計算し、8:1 の比率でオーバーワールドとネザーを変換。必要な黒曜石数も算出します。",
      ko: "네더 포털 좌표를 계산하고 오버월드와 네더를 8:1 비율로 변환하며 흑요석 필요량을 확인하세요.",
      es: "Calcula coordenadas del portal del Nether, convierte Mundo Superior a Nether en 8:1 y estima la obsidiana necesaria.",
      fr: "Calculez les coordonnées du portail du Nether, convertissez l’Overworld au ratio 8:1 et estimez l’obsidienne requise.",
      de: "Berechne Netherportal-Koordinaten, wandle Oberwelt in Nether im Verhältnis 8:1 um und ermittle den Obsidianbedarf.",
      pt: "Calcule coordenadas do portal do Nether, converta Mundo Superior para Nether na proporção 8:1 e veja a obsidiana necessária.",
      ru: "Рассчитайте координаты портала в Незер, переведите Верхний мир в Незер по 8:1 и узнайте нужное количество обсидиана."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "xinnian-daojishi-jisuanqi",
      "zh-TW": "xinnian-daojishi-jisuanqi",
      ja: "shinnen-countdown-keisanki",
      ko: "sin-nyeon-countdown-gyesangi",
      es: "calculadora-cuenta-regresiva-ano-nuevo",
      fr: "calculateur-compte-a-rebours-nouvel-an",
      de: "neujahr-countdown-rechner",
      pt: "calculadora-contagem-regressiva-ano-novo",
      ru: "kalkulyator-obratnogo-otscheta-do-novogo-goda"
    },
    titles: {
      en: "New Year Countdown Calculator - Time Until New Year",
      "zh-CN": "新年倒计时计算器 - 距离新年还有多久",
      "zh-TW": "新年倒數計算器 - 距離新年還有多久",
      ja: "新年カウントダウン計算機 - 新年までの時間",
      ko: "새해 카운트다운 계산기 - 새해까지 남은 시간",
      es: "Calculadora de cuenta regresiva de Año Nuevo",
      fr: "Compte à rebours Nouvel An - temps restant",
      de: "Neujahr-Countdown-Rechner - Zeit bis Neujahr",
      pt: "Calculadora de contagem regressiva de Ano Novo",
      ru: "Таймер до Нового года - обратный отсчет"
    },
    descriptions: {
      ...
      "zh-CN": "用实时倒计时精确计算距离新年还有多少天、小时、分钟和秒。支持所有时区，准确对应当地午夜。",
      "zh-TW": "用即時倒數精準計算距離新年還有多少天、小時、分鐘和秒。支援所有時區，準確對應當地午夜。",
      ja: "新年までの日数、時間、分、秒をライブカウントダウンで正確に計算。全タイムゾーンに対応し、現地の午前0時に合わせます。",
      ko: "라이브 카운트다운으로 새해까지 남은 일, 시간, 분, 초를 정확히 계산하세요. 모든 시간대를 지원해 현지 자정에 맞춥니다.",
      es: "Calcula días, horas, minutos y segundos hasta Año Nuevo con un temporizador en vivo. Compatible con todas las zonas horarias.",
      fr: "Calculez les jours, heures, minutes et secondes avant le Nouvel An avec un minuteur en direct. Toutes les zones horaires sont prises en charge.",
      de: "Berechnen Sie Tage, Stunden, Minuten und Sekunden bis Neujahr mit Live-Countdown. Unterstützt alle Zeitzonen für lokale Mitternacht.",
      pt: "Calcule dias, horas, minutos e segundos até o Ano Novo com temporizador ao vivo. Suporta todos os fusos para meia-noite local precisa.",
      ru: "Рассчитайте дни, часы, минуты и секунды до Нового года с живым таймером. Поддержка всех часовых поясов для местной полуночи."
    }
  },
  {
  ...
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "yin-jie-ji-suan-qi-yin-jie-diao-shi",
      "zh-TW": "yin-jie-ji-suan-qi-yin-jie-diao-shi",
      ja: "ongaku-sukeiru-keisanki-sukeiru-modo",
      ko: "eumgak-seukeil-gyesan-gi-seukeil-modeu",
      es: "calculadora-escalas-musicales-modos",
      fr: "calculateur-gammes-musicales-modes",
      de: "tonleiter-rechner-modi-skalen",
      pt: "calculadora-escalas-musicais-modos",
      ru: "kalkulyator-muzykalnykh-gamm"
    },
    titles: {
      ...
      ja: "音階計算機 - スケールとモード",
      ko: "음계 계산기 - 스케일과 모드",
      es: "Calculadora de escalas musicales - modos",
      fr: "Calculateur de gammes musicales - modes",
      de: "Tonleiter-Rechner - Modi und Skalen",
      pt: "Calculadora de escalas musicais - modos",
      ru: "Калькулятор музыкальных гамм"
    },
    descriptions: {
      ...
      "zh-CN": "输入根音，计算大调、小调、五声音阶、布鲁斯音阶和调式，并快速查看音符列表。",
      "zh-TW": "輸入根音，計算大調、小調、五聲音階、藍調音階和調式，並快速查看音符列表。",
      ja: "ルート音からメジャー、マイナー、ペンタトニック、ブルース、各モードの音を計算します。",
      ko: "루트 음으로 메이저, 마이너, 펜타토닉, 블루스, 모드 음계를 계산하고 확인하세요.",
      es: "Calcula escalas, modos, pentatónicas y blues a partir de cualquier nota raíz.",
      fr: "Calculez des gammes, modes, pentatoniques et blues à partir de n'importe quelle tonique.",
      de: "Berechnen Sie Skalen, Modi, Pentatonik und Blues für jeden Grundton.",
      pt: "Calcule escalas, modos, pentatônicas e blues para qualquer tônica.",
      ru: "Рассчитывайте гаммы, лады, пентатонику и блюз от любой тоники."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "yinyue-zhuandiaojisuanqi",
      "zh-TW": "yinyue-zhuandiaojisuanqi",
      ja: "ongaku-ichou-keisanki",
      ko: "eumak-ijong-gesangi",
      es: "calculadora-transposicion-musical",
      fr: "calculateur-transposition-musicale",
      de: "musik-transpositionsrechner",
      pt: "calculadora-transposicao-musical",
      ru: "muzykalnyj-kalkulyator-transpozicii"
    },
    titles: {
      ...
      ja: "音楽移調計算機",
      ko: "음악 이조 계산기",
      es: "Calculadora de transposición musical",
      fr: "Calculateur de transposition musicale",
      de: "Musik-Transpositionsrechner",
      pt: "Calculadora de transposição musical",
      ru: "Музыкальный калькулятор транспозиции"
    },
    descriptions: {
      ...
      "zh-CN": "立即移调音符和调性。可转换不同调、计算半音差，并学习任何乐器的移调方法。",
      "zh-TW": "立即移調音符和調性。可轉換不同調、計算半音差，並學習任何樂器的移調方法。",
      ja: "音符とキーをすぐに移調。異なる調の変換、半音差の計算、あらゆる楽器の移調学習に対応。",
      ko: "음표와 조를 즉시 이조하세요. 다른 조로 변환하고, 반음 차이를 계산하며, 어떤 악기든 이조를 배울 수 있습니다.",
      es: "Transpone notas y tonalidades al instante. Convierte entre tonalidades, calcula semitonos y aprende transposición para cualquier instrumento.",
      fr: "Transposez instantanément notes et tonalités. Convertissez entre tonalités, calculez les demi-tons et apprenez la transposition pour tout instrument.",
      de: "Transponieren Sie Noten und Tonarten sofort. Wechseln Sie zwischen Tonarten, berechnen Sie Halbtöne und lernen Sie Transposition für jedes Instrument.",
      pt: "Transponha notas e tonalidades instantaneamente. Converta entre tonalidades, calcule semitons e aprenda transposição para qualquer instrumento.",
      ru: "Мгновенно транспонируйте ноты и тональности. Переключайтесь между тональностями, считайте полутоны и изучайте транспозицию для любого инструмента."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "minecraft-dui-die-ji-suan-qi",
      "zh-TW": "minecraft-dui-die-ji-suan-qi",
      ja: "maikurafuto-sutakku-keisanki",
      ko: "maikeuraepeuteu-seutaek-gyeonsangi",
      es: "calculadora-stacks-minecraft",
      fr: "calculateur-stacks-minecraft",
      de: "minecraft-stack-rechner",
      pt: "calculadora-stacks-minecraft",
      ru: "kalkulyator-stakov-minecraft"
    },
    titles: {
      en: "Minecraft Stack Calculator - Item & Storage Planner",
      "zh-CN": "Minecraft 堆叠计算器 - 物品与存储规划器",
      "zh-TW": "Minecraft 堆疊計算器 - 物品與儲存規劃器",
      ja: "Minecraftスタック計算機 - 収納プランナー",
      ko: "Minecraft 스택 계산기 - 저장 플래너",
      es: "Calculadora de stacks de Minecraft - Planificador",
      fr: "Calculateur de stacks Minecraft - Planificateur",
      de: "Minecraft-Stack-Rechner - Lagerplaner",
      pt: "Calculadora de stacks do Minecraft - Planejador",
      ru: "Калькулятор стаков Minecraft - планировщик"
    },
    descriptions: {
      ...
      "zh-CN": "计算 Minecraft 物品堆叠、潜影盒容量和物品栏格数。用精确的堆叠数量为任意资源量优化存储。",
      "zh-TW": "計算 Minecraft 物品堆疊、潛影盒容量與物品欄格數。用精確的堆疊數量為任何資源量最佳化儲存。",
      ja: "Minecraftのアイテムスタック数、シュルカーボックス容量、所持品スロットを計算。正確な個数で収納を最適化できます。",
      ko: "Minecraft 아이템 스택 수, 셜커 박스 용량, 인벤토리 슬롯을 계산합니다. 정확한 개수로 저장 공간을 최적화하세요.",
      es: "Calcula stacks, cajas de shulker y ranuras de inventario para cualquier cantidad de objetos de Minecraft. Optimiza tu almacenamiento con precisión.",
      fr: "Calculez les stacks, boîtes de shulker et emplacements d'inventaire nécessaires pour n'importe quel objet Minecraft. Optimisez le stockage avec précision.",
      de: "Berechne Stacks, Shulkerkisten und Inventarslots für jede Minecraft-Itemmenge. Optimiere deinen Lagerplatz mit präzisen Mengen.",
      pt: "Calcule stacks, shulker boxes e espaços do inventário para qualquer quantidade de itens do Minecraft. Otimize o armazenamento com precisão.",
      ru: "Рассчитайте стаки, шалкер-боксы и слоты инвентаря для любого количества предметов Minecraft. Оптимизируйте хранение точно."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "minecraft-mo-di-chuan-song-men-yao-sai-ding-wei",
      "zh-TW": "minecraft-mo-di-chuan-song-men-yao-sai-ding-wei",
      ja: "minecraft-endo-potoru-yousai-ichi-keisan",
      ko: "maineukraepteu-endeu-poteol-yosae-chatgi",
      es: "minecraft-localizador-portal-del-ender-bastion",
      fr: "minecraft-localisateur-portail-de-lend-forteresse",
      de: "minecraft-endportal-stronghold-finder",
      pt: "minecraft-localizador-portal-do-fim-fortaleza",
      ru: "poisk-portala-kraya-minecraft-krepost"
    },
    titles: {
      en: "Minecraft End Portal Finder - Locate Strongholds",
      "zh-CN": "Minecraft末地传送门定位器：寻找要塞",
      "zh-TW": "Minecraft末地傳送門定位器：尋找要塞",
      ja: "Minecraftエンドポータル要塞位置計算",
      ko: "마인크래프트 엔드 포털 요새 찾기",
      es: "Localizador de Portal del End en Minecraft",
      fr: "Localisateur de Portail de l’End Minecraft",
      de: "Minecraft Endportal-Finder für Festungen",
      pt: "Localizador de Portal do Fim no Minecraft",
      ru: "Поиск портала Края в Minecraft"
    },
    descriptions: {
      ...
      "zh-CN": "通过末影之眼的角度和距离计算寻找Minecraft要塞，支持单次投掷和可选二次投掷估算。",
      "zh-TW": "透過終界之眼的角度與距離計算尋找Minecraft要塞，支援單次投擲與可選第二次投擲估算。",
      ja: "アイ・オブ・エンダーの角度と距離でMinecraftの要塞を探す計算ツール。1回投げと2回投げの推定に対応。",
      ko: "엔더의 눈 각도와 거리로 마인크래프트 요새를 찾는 계산기. 한 번 던지기와 두 번째 던지기 추정에 대응합니다.",
      es: "Calcula fortalezas de Minecraft con el ángulo y la distancia del Ojo de Ender. Admite una estimación de un lanzamiento y un segundo lanzamiento opcional.",
      fr: "Trouvez les forteresses Minecraft grâce à l’angle et à la distance de l’Œil de l’Ender. Estimation à un lancer et second lancer optionnel.",
      de: "Finde Minecraft-Festungen mit Winkel- und Distanzberechnung der Enderperle. Unterstützt einen Einwurf und optional einen zweiten.",
      pt: "Encontre fortalezas do Minecraft com o ângulo e a distância do Olho de Ender. Suporta uma estimativa com um lançamento e um segundo opcional.",
      ru: "Найдите крепости Minecraft по углу и дистанции полёта Ока Края. Поддерживается оценка по одному броску и второй бросок."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "minecraft-yuanxing-shengchengqi",
      "zh-TW": "minecraft-yuanxing-shengchengqi",
      ja: "minecraft-enkei-seiseiki",
      ko: "minecraft-yeonhyeong-saengseonggi",
      es: "generador-circulos-minecraft",
      fr: "generateur-cercles-minecraft",
      de: "minecraft-kreis-generator",
      pt: "gerador-circulos-minecraft",
      ru: "minecraft-generator-krugov"
    },
    titles: {
      en: "Minecraft Circle Generator - Pixel Perfect Circles",
      "zh-CN": "Minecraft圆形生成器",
      "zh-TW": "Minecraft圓形生成器",
      ja: "Minecraft円形生成器",
      ko: "Minecraft 원형 생성기",
      es: "Generador de círculos de Minecraft",
      fr: "Générateur de cercles Minecraft",
      de: "Minecraft-Kreisgenerator",
      pt: "Gerador de círculos de Minecraft",
      ru: "Генератор кругов Minecraft"
    },
    descriptions: {
      ...
      "zh-CN": "生成像素级精准的Minecraft圆形，支持精确方块坐标、Midpoint与Bresenham算法，以及轮廓或填充模式。",
      "zh-TW": "產生像素級精準的Minecraft圓形，支援精確方塊座標、Midpoint與Bresenham演算法，以及輪廓或填滿模式。",
      ja: "正確なブロック座標でピクセル単位のMinecraft円を生成。MidpointとBresenhamの両アルゴリズムに対応し、輪郭と塗りつぶしを選べます。",
      ko: "정확한 블록 좌표로 픽셀 단위의 Minecraft 원을 생성하세요. Midpoint와 Bresenham 알고리즘, 윤곽선/채움 옵션을 지원합니다.",
      es: "Genera círculos de Minecraft con precisión de píxel y coordenadas exactas. Compatible con Midpoint y Bresenham, con contorno o relleno.",
      fr: "Générez des cercles Minecraft au pixel près avec des coordonnées exactes. Prend en charge Midpoint et Bresenham, avec contour ou remplissage.",
      de: "Erzeuge pixelgenaue Minecraft-Kreise mit exakten Blockkoordinaten. Unterstützt Midpoint und Bresenham sowie Umriss oder Füllung.",
      pt: "Gere círculos de Minecraft com precisão de pixel e coordenadas exatas. Suporta Midpoint e Bresenham, com contorno ou preenchido.",
      ru: "Создавайте пиксельно точные круги Minecraft с точными координатами блоков. Поддерживаются Midpoint и Bresenham, контур и заливка."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "mayan-lifa-zhuanhuan",
      "zh-TW": "mayan-lifa-zhuanhuan",
      ja: "mayan-rekki-henkan",
      ko: "maya-ryeok-byeonhwan",
      es: "convertidor-calendario-maya",
      fr: "convertisseur-calendrier-maya",
      de: "maya-kalender-konverter",
      pt: "conversor-calendario-maia",
      ru: "konverter-kalendarya-mayya"
    },
    titles: {
      en: "Mayan Calendar Converter - Gregorian to Mayan Date",
      "zh-CN": "玛雅历转换器：公历转玛雅日期",
      "zh-TW": "瑪雅曆轉換器：公曆轉瑪雅日期",
      ja: "マヤ暦変換器：西暦からマヤ日付へ",
      ko: "마야력 변환기: 그레고리력에서 마야 날짜로",
      es: "Convertidor del calendario maya",
      fr: "Convertisseur du calendrier maya",
      de: "Maya-Kalender-Konverter",
      pt: "Conversor do calendário maia",
      ru: "Конвертер календаря майя"
    },
    descriptions: {
      ...
      "zh-CN": "将公历日期转换为玛雅长纪、卓尔金和哈布历，并支持玛雅日期反查公历。",
      "zh-TW": "將公曆日期轉換為瑪雅長紀、卓爾金和哈布曆，並支援瑪雅日期反查公曆。",
      ja: "西暦をマヤ長期暦・ツォルキン・ハアブへ変換し、マヤ日付から西暦への逆変換もできます。",
      ko: "그레고리력을 마야 장기력·촐킨·하아브로 변환하고, 마야 날짜를 그레고리력으로도 바꿀 수 있습니다.",
      es: "Convierte fechas gregorianas al largo cuenta maya, Tzolkin y Haab, con conversión inversa de Maya a gregoriano.",
      fr: "Convertissez des dates grégoriennes en Long Count maya, Tzolkin et Haab, avec conversion inverse maya vers grégorien.",
      de: "Gregorianische Daten in Maya-Langzählung, Tzolkin und Haab umrechnen und umgekehrt ins Gregoriansche zurück.",
      pt: "Converta datas gregorianas para a Contagem Longa, Tzolkin e Haab maias, com conversão inversa para o gregoriano.",
      ru: "Преобразуйте григорианские даты в Длинный счёт, Цолькин и Хааб майя и обратно в григорианский формат."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "pipei-touzhu-jisuanqi",
      "zh-TW": "pipei-touzhu-jisuanqi",
      ja: "macchi-bettingu-keisanki",
      ko: "maechi-beting-gyesangi",
      es: "calculadora-apuestas-combinadas",
      fr: "calculateur-matched-betting",
      de: "matched-betting-rechner",
      pt: "calculadora-apostas-combinadas",
      ru: "kalkulyator-matched-betting"
    },
    titles: {
      en: "Matched Betting Calculator - Risk-Free Profits",
      "zh-CN": "匹配投注计算器 - 无风险收益",
      "zh-TW": "配對投注計算器 - 無風險收益",
      ja: "マッチベッティング計算機 - リスクなし利益",
      ko: "매치드 베팅 계산기 - 무위험 수익",
      es: "Calculadora de matched betting - ganancias sin riesgo",
      fr: "Calculateur matched betting - profits sans risque",
      de: "Matched-Betting-Rechner - risikofreie Gewinne",
      pt: "Calculadora de matched betting - lucro sem risco",
      ru: "Калькулятор matched betting - прибыль без риска"
    },
    descriptions: {
      ...
      "zh-CN": "计算匹配投注和博彩商奖金的最佳反向下注额、资格亏损与保证利润。免费匹配投注工具。",
      "zh-TW": "計算配對投注與博彩公司獎金的最佳反向下注額、資格虧損和保證利潤。免費配對投注工具。",
      ja: "マッチベッティングとブックメーカー特典の最適なレイ賭け金、 qualifying loss、保証利益を計算。無料ツール。",
      ko: "매치드 베팅과 북메이커 보너스의 최적 레이 베팅액, 조건 충족 손실, 보장 수익을 계산하세요. 무료 도구.",
      es: "Calcula apuestas lay óptimas, pérdidas de calificación y ganancias garantizadas con matched betting y bonos de casas de apuestas.",
      fr: "Calculez mises lay optimales, pertes de qualification et profits garantis avec le matched betting et les bonus bookmakers.",
      de: "Berechne optimale Lay-Einsätze, Qualifikationsverluste und garantierte Gewinne aus Matched Betting und Buchmacherboni.",
      pt: "Calcule apostas lay ideais, perdas qualificatórias e lucros garantidos com matched betting e bônus de casas de apostas.",
      ru: "Рассчитайте оптимальные lay-ставки, квалификационные убытки и гарантированную прибыль от matched betting и бонусов букмекеров."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "baoguang-jisuanqi",
      "zh-TW": "baoguang-jisuanqi",
      ja: "roko-ryo-keisan-ki",
      ko: "balgwang-gyesangi",
      es: "calculadora-exposicion",
      fr: "calculateur-exposition",
      de: "belichtungsrechner",
      pt: "calculadora-exposicao",
      ru: "kalkulyator-ekspozitsii"
    },
    titles: {
      ...
      ja: "露出計算機",
      ko: "노출 계산기",
      es: "Calculadora de exposición",
      fr: "Calculateur d’exposition",
      de: "Belichtungsrechner",
      pt: "Calculadora de exposição",
      ru: "Калькулятор экспозиции"
    },
    descriptions: {
      ...
      "zh-CN": "根据光圈、快门速度和 ISO 计算相机曝光值，掌握曝光三角，轻松应对各种光线条件。",
      "zh-TW": "根據光圈、快門速度與 ISO 計算相機曝光值，掌握曝光三角，輕鬆應對各種光線條件。",
      ja: "絞り、シャッタースピード、ISO からカメラの露出値を計算し、露出の三角形を理解して最適な明るさを実現します。",
      ko: "조리개, 셔터 속도, ISO로 카메라 노출 값을 계산하고 노출 삼각형을 이해해 완벽한 밝기를 맞추세요.",
      es: "Calcula el valor de exposición de la cámara con apertura, velocidad e ISO y domina el triángulo de exposición.",
      fr: "Calculez la valeur d’exposition d’un appareil photo à partir de l’ouverture, de la vitesse et de l’ISO.",
      de: "Berechnen Sie den Belichtungswert Ihrer Kamera mit Blende, Verschlusszeit und ISO und meistern Sie das Belichtungsdreieck.",
      pt: "Calcule o valor de exposição da câmera com abertura, velocidade e ISO e domine o triângulo de exposição.",
      ru: "Рассчитайте экспозицию камеры по диафрагме, выдержке и ISO и освойте треугольник экспозиции."
    }
  },
  {
    id: "film-calculator",
    ...
    slugs: {
      en: "film-calculator",
      "zh-CN": "yingpian-jisuanqi",
      "zh-TW": "yingpian-jisuanqi",
      ja: "firumu-keisan-ki",
      ko: "pilreum-gyesan-gi",
      es: "calculadora-pelicula",
      fr: "calculateur-film",
      de: "filmrechner",
      pt: "calculadora-filme",
      ru: "film-kalkulyator"
    },
    titles: {
      ...
      ja: "フィルム計算機 - 長さと制作費",
      ko: "필름 계산기 - 길이와 제작 비용",
      es: "Calculadora de película - Longitud y costos",
      fr: "Calculateur de film - Longueur et coûts",
      de: "Filmrechner - Länge und Produktionskosten",
      pt: "Calculadora de filme - Comprimento e custos",
      ru: "Калькулятор плёнки - длина и стоимость"
    },
    descriptions: {
      ...
      "zh-CN": "计算 35mm、16mm、Super 8 和 70mm 的影片长度、卷数与制作成本，精准规划拍摄预算。",
      "zh-TW": "計算 35mm、16mm、Super 8 和 70mm 的影片長度、卷數與製作成本，精準規劃拍攝預算。",
      ja: "35mm、16mm、Super 8、70mm のフィルム長、リール数、制作費を計算し、撮影予算を正確に立てられます。",
      ko: "35mm, 16mm, Super 8, 70mm의 필름 길이, 릴 수, 제작 비용을 계산해 촬영 예산을 정확히 세워보세요.",
      es: "Calcula la longitud de película, el número de rollos y los costos de producción para 35 mm, 16 mm, Super 8 y 70 mm.",
      fr: "Calculez la longueur de pellicule, le nombre de bobines et les coûts de production pour 35 mm, 16 mm, Super 8 et 70 mm.",
      de: "Berechnen Sie Filmlänge, Rollenanzahl und Produktionskosten für 35 mm, 16 mm, Super 8 und 70 mm.",
      pt: "Calcule o comprimento do filme, o número de rolos e os custos de produção para 35mm, 16mm, Super 8 e 70mm.",
      ru: "Рассчитайте длину плёнки, количество катушек и стоимость производства для 35 мм, 16 мм, Super 8 и 70 мм."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "zuizhong-chengji-jisuanqi",
      "zh-TW": "zuizhong-chengji-jisuanqi",
      ja: "saishu-seiseki-keisan",
      ko: "choejong-seongjeok-gigye",
      es: "calculadora-nota-final",
      fr: "calculatrice-note-finale",
      de: "endnotenrechner",
      pt: "calculadora-nota-final",
      ru: "kalkulyator-itogovoy-otsenki"
    },
    titles: {
      ...
      fr: "Calculatrice de note finale",
      de: "Endnotenrechner",
      pt: "Calculadora de nota final",
      ru: "Калькулятор итоговой оценки"
    },
    descriptions: {
      ...
      "zh-CN": "根据当前成绩和期末考试分数，使用加权平均计算你的课程最终成绩。",
      "zh-TW": "根據目前成績與期末考分數，使用加權平均計算你的課程總成績。",
      ja: "現在の成績と期末試験の点数から、加重平均で最終成績を計算します。",
      ko: "현재 성적과 기말고사 점수를 가중 평균으로 계산해 최종 성적을 확인하세요.",
      es: "Calcula tu nota final con tu rendimiento actual y el examen final usando promedios ponderados.",
      fr: "Calculez votre note finale à partir de votre performance actuelle et de l’examen final avec une moyenne pondérée.",
      de: "Berechnen Sie Ihre Endnote aus aktueller Leistung und Klausurpunktzahl mit gewichteten Durchschnittswerten.",
      pt: "Calcule sua nota final a partir do desempenho atual e da prova final usando média ponderada.",
      ru: "Рассчитайте итоговую оценку по текущему результату и экзамену с помощью взвешенного среднего."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "meiguo-guoqi-jisuanqi",
      "zh-TW": "meiguo-guoqi-jisuanqi",
      ja: "amerika-kokki-keisanki",
      ko: "miguk-gukgi-gyeonsangi",
      es: "calculadora-bandera-eeuu",
      fr: "calculateur-drapeau-americain",
      de: "us-flaggen-rechner",
      pt: "calculadora-bandeira-eua",
      ru: "kalkulyator-flaga-ssha"
    },
    titles: {
      ...
      ja: "アメリカ国旗サイズ計算機",
      ko: "미국 국기 크기 계산기",
      es: "Calculadora de la bandera de EE. UU.",
      fr: "Calculateur de drapeau américain",
      de: "US-Flaggen-Rechner",
      pt: "Calculadora da bandeira dos EUA",
      ru: "Калькулятор флага США"
    },
    descriptions: {
      ...
      "zh-CN": "计算任意尺寸美国国旗的长宽、联邦区、条纹和星星尺寸，依据官方行政命令 10834。",
      "zh-TW": "計算任意尺寸美國國旗的長寬、聯邦區、條紋和星星尺寸，依據官方行政命令 10834。",
      ja: "任意のサイズのアメリカ国旗の寸法、比率、各部の計測値を計算します。公式の大統領令10834号に準拠。",
      ko: "어떤 크기든 미국 국기의 치수, 비율, 측정값을 계산합니다. 공식 행정명령 10834를 기준으로 합니다.",
      es: "Calcula las dimensiones, proporciones y medidas de la bandera estadounidense para cualquier tamaño, según la Orden Ejecutiva 10834.",
      fr: "Calculez les dimensions, proportions et mesures du drapeau américain pour toute taille, selon l’ordre exécutif 10834.",
      de: "Berechnen Sie Abmessungen, Proportionen und Maße der US-Flagge für jede Größe – basierend auf Executive Order 10834.",
      pt: "Calcule as dimensões, proporções e medidas da bandeira americana para qualquer tamanho, com base na Ordem Executiva 10834.",
      ru: "Рассчитайте размеры, пропорции и параметры флага США для любого размера по официальному указу 10834."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "ieee-754-fudian-shu-ji-suan-qi",
      "zh-TW": "ieee-754-fudian-shu-ji-suan-qi",
      ja: "ieee-754-fudoshousuuten-keisanki",
      ko: "ieee-754-puldong-sosujeom-gyesangi",
      es: "calculadora-punto-flotante-ieee-754",
      fr: "calculatrice-virgule-flottante-ieee-754",
      de: "ieee-754-gleitkomma-rechner",
      pt: "calculadora-ponto-flutuante-ieee-754",
      ru: "kalkulyator-chisel-s-plavayushchey-tochkoy-ieee-754"
    },
    titles: {
      ...
      ja: "浮動小数点計算機",
      ko: "부동소수점 계산기",
      es: "Calculadora de punto flotante",
      fr: "Calculatrice de nombres à virgule flottante",
      de: "Gleitkomma-Rechner",
      pt: "Calculadora de ponto flutuante",
      ru: "Калькулятор чисел с плавающей точкой"
    },
    descriptions: {
      ...
      "zh-CN": "将十进制数转换为 IEEE 754 二进制格式，并分析符号位、指数、尾数和舍入误差。",
      "zh-TW": "將十進位數轉換為 IEEE 754 二進位格式，並分析符號位、指數、尾數與捨入誤差。",
      ja: "10進数を IEEE 754 のバイナリ表現に変換し、符号・指数・仮数・丸め誤差を解析します。",
      ko: "10진수를 IEEE 754 이진 표현으로 변환하고 부호, 지수, 가수, 반올림 오차를 분석합니다.",
      es: "Convierte números decimales al formato binario IEEE 754 y analiza signo, exponente, mantisa y error de redondeo.",
      fr: "Convertissez des nombres décimaux en représentation binaire IEEE 754 et analysez le signe, l’exposant, la mantisse et l’erreur d’arrondi.",
      de: "Wandelt Dezimalzahlen in das IEEE-754-Binärformat um und analysiert Vorzeichen, Exponent, Mantisse und Rundungsfehler.",
      pt: "Converta números decimais para a forma binária IEEE 754 e analise sinal, expoente, mantissa e erro de arredondamento.",
      ru: "Преобразуйте десятичные числа в двоичный формат IEEE 754 и анализируйте знак, экспоненту, мантиссу и ошибку округления."
    }
  },
  {
    id: "gpa-calculator",
    ...
    slugs: {
      en: "gpa-calculator",
      "zh-CN": "gpa-ji-suan-qi",
      "zh-TW": "gpa-ji-suan-qi",
      ja: "gpa-keisan-ki",
      ko: "gpa-gyeongsan-gi",
      es: "calculadora-gpa",
      fr: "calculateur-gpa",
    ...
    titles: {
      ...
      ja: "GPA計算ツール - 平均成績を計算",
      ko: "GPA 계산기 - 평점 평균 계산",
      es: "Calculadora GPA - Calcula tu promedio",
      fr: "Calculateur de GPA - Calculer la moyenne",
      de: "GPA-Rechner - Notendurchschnitt berechnen",
      pt: "Calculadora de GPA - Calcule sua média",
      ru: "Калькулятор GPA - рассчитать средний балл"
    },
    descriptions: {
      ...
      "zh-CN": "使用标准4.0绩点制计算你的GPA。输入课程、字母成绩和学分，立即得到加权平均绩点结果。",
      "zh-TW": "使用標準4.0績點制計算你的GPA。輸入課程、字母成績和學分，立即得到加權平均績點結果。",
      ja: "標準的な4.0スケールでGPAを計算。科目名、成績、単位数を入力して、加重平均のGPAをすぐに確認できます。",
      ko: "표준 4.0 기준으로 GPA를 계산하세요. 과목, 문자 등급, 학점을 입력하면 가중 평균 GPA를 바로 확인할 수 있습니다.",
      es: "Calcula tu GPA con la escala estándar de 4.0. Ingresa cursos, calificaciones y horas crédito para ver tu promedio ponderado al instante.",
      fr: "Calculez votre GPA avec l'échelle standard de 4.0. Saisissez les cours, les notes et les crédits pour obtenir immédiatement une moyenne pondérée.",
      de: "Berechnen Sie Ihren GPA mit der standardmäßigen 4.0-Skala. Kurse, Noten und Credit Hours eingeben und sofort den gewichteten Durchschnitt erhalten.",
      pt: "Calcule seu GPA na escala padrão de 4.0. Informe disciplinas, notas e horas de crédito para ver a média ponderada na hora.",
      ru: "Рассчитайте GPA по стандартной шкале 4.0. Введите курсы, буквенные оценки и кредитные часы, чтобы сразу получить взвешенный средний балл."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "gpa-jisuanqi-bajisitan-chengji-zhuanhuan",
      "zh-TW": "gpa-jisuanqi-bajisitan-chengji-zhuanhuan",
      ja: "gpa-keisanki-pakisutan-seiseki-henkan",
      ko: "gpa-gyeonsangi-pakiseutan-seongjeok-byeonhwan",
      es: "calculadora-gpa-pakistan-convertir-notas",
      fr: "calculateur-gpa-pakistan-convertir-notes",
      de: "gpa-rechner-pakistan-noten-umrechnen",
      pt: "calculadora-gpa-paquistao-converter-notas",
      ru: "gpa-kalkulyator-pakistan-perevod-ocenok"
    },
    titles: {
      en: "GPA Calculator Pakistan - Convert Grades to 4.0 GPA",
      "zh-CN": "巴基斯坦GPA计算器：百分制与等级换算",
      "zh-TW": "巴基斯坦GPA計算器：百分制與等級換算",
      ja: "パキスタンGPA計算機：成績をGPAに換算",
      ko: "파키스탄 GPA 계산기: 성적을 GPA로 변환",
      es: "Calculadora GPA Pakistán: convierte notas a GPA",
      fr: "Calculateur GPA Pakistan : convertir les notes en GPA",
      de: "Pakistan GPA-Rechner: Noten in GPA umrechnen",
      pt: "Calculadora GPA Paquistão: converter notas em GPA",
      ru: "Калькулятор GPA Пакистана: перевод оценок в GPA"
    },
    descriptions: {
      ...
      "zh-CN": "将巴基斯坦大学成绩（百分制或字母）转换为HEC 4.0 GPA，支持混合输入，精准计算学业绩点。",
      "zh-TW": "將巴基斯坦大學成績（百分制或字母）換算為 HEC 4.0 GPA，支援混合輸入，精準計算學業績點。",
      ja: "パキスタン大学の成績をHEC 4.0基準のGPAに変換。百分率と評点の混在入力に対応します。",
      ko: "파키스탄 대학 성적을 HEC 4.0 기준 GPA로 변환합니다. 백분율과 문자 성적의 혼합 입력을 지원합니다.",
      es: "Convierte notas universitarias de Pakistán al GPA 4.0 de HEC. Acepta porcentajes y letras en una misma cuenta.",
      fr: "Convertissez les notes universitaires pakistanaises en GPA 4.0 HEC. Gère les pourcentages et les lettres en entrée mixte.",
      de: "Wandle pakistanische Hochschulnoten in den HEC-4.0-GPA um. Unterstützt Prozent- und Buchstabennoten in einer Eingabe.",
      pt: "Converta notas universitárias do Paquistão para o GPA 4.0 da HEC. Aceita porcentagens e letras na mesma conta.",
      ru: "Переводит оценки пакистанских вузов в GPA по шкале HEC 4.0. Поддерживает процентные и буквенные оценки."
    }
  },
  {
    id: "grade-calculator",
    ...
    slugs: {
      en: "grade-calculator",
      "zh-CN": "gpa-chengji-jisuanqi",
      "zh-TW": "gpa-chengji-jisuanqi",
      ja: "gpa-seiseki-keisanki",
      ko: "gpa-seongjeok-gyesangi",
      es: "calculadora-gpa-notas",
      fr: "calculateur-gpa-notes",
      de: "gpa-notenrechner",
      pt: "calculadora-gpa-notas",
      ru: "kalkulyator-gpa-otsenok"
    },
    titles: {
      en: "Grade Calculator - Calculate Academic Grades and GPA",
      "zh-CN": "GPA成绩计算器 - 计算课程成绩与平均绩点",
      "zh-TW": "GPA成績計算器 - 計算課程成績與平均績點",
      ja: "GPA成績計算機 - 科目成績と平均評価点を計算",
      ko: "GPA 성적 계산기 - 과목 성적과 평균 평점 계산",
      es: "Calculadora de GPA - Calcula notas académicas",
      fr: "Calculateur de GPA - Calculer notes et moyenne",
      de: "GPA-Notenrechner - Studiennoten und GPA berechnen",
      pt: "Calculadora de GPA - Calcule notas e média acadêmica",
      ru: "Калькулятор GPA - расчет оценок и среднего балла"
    },
    descriptions: {
      ...
      "zh-CN": "按学分加权，根据字母或数字成绩计算GPA。支持混合评分制，并显示每门课的字母等级换算。",
      "zh-TW": "依學分加權，從字母或數字成績計算GPA。支援混合評分制，並顯示每門課的字母等第換算。",
      ja: "文字評価または数値成績から、単位数で加重したGPAを計算。混在する評価方式に対応し、科目ごとの文字評価換算も表示します。",
      ko: "문자 등급 또는 숫자 점수에서 학점 가중 GPA를 계산합니다. 혼합 성적 체계를 지원하고 과목별 문자 등급 변환을 보여줍니다.",
      es: "Calcula el GPA desde calificaciones con letras o notas numéricas, ponderado por créditos. Admite sistemas mixtos y muestra conversiones por curso.",
      fr: "Calculez le GPA à partir de notes lettres ou numériques avec pondération par crédits. Prend en charge les systèmes mixtes et affiche les conversions.",
      de: "Berechne den GPA aus Buchstaben- oder Zahlennoten mit Kreditstunden-Gewichtung. Unterstützt gemischte Notensysteme und Kursumrechnungen.",
      pt: "Calcule o GPA por notas em letras ou números, ponderado por créditos. Suporta sistemas mistos e mostra conversões por disciplina.",
      ru: "Рассчитайте GPA по буквенным или числовым оценкам с весом кредитных часов. Поддерживает смешанные системы и конвертацию по курсам."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "gsd-jisuanqi-dimian-caoyang-juli",
      "zh-TW": "gsd-jisuanqi-dimian-caiyang-juli",
      ja: "gsd-keisanki-chijo-sampling-kyori",
      ko: "gsd-gyesangi-jimyeon-pyobon-geori",
      es: "calculadora-gsd-distancia-muestreo-terreno",
      fr: "calculateur-gsd-distance-echantillonnage-sol",
      de: "gsd-rechner-bodenaufloesung-drohnenkartierung",
      pt: "calculadora-gsd-distancia-amostragem-solo",
      ru: "kalkulyator-gsd-rasstoyanie-nazemnoy-vyborki"
    },
    titles: {
      en: "GSD Calculator - Ground Sample Distance for Drone Mapping",
      "zh-CN": "GSD计算器 - 无人机测绘地面采样距离",
      "zh-TW": "GSD計算器 - 無人機測繪地面採樣距離",
      ja: "GSD計算機 - ドローン測量の地上画素寸法",
      ko: "GSD 계산기 - 드론 매핑 지상 표본 거리",
      es: "Calculadora GSD - distancia de muestreo del terreno",
      fr: "Calculateur GSD - distance d’échantillonnage au sol",
      de: "GSD-Rechner - Bodenauflösung für Drohnenkartierung",
      pt: "Calculadora GSD - distância de amostragem do solo",
      ru: "Калькулятор GSD - наземное разрешение для дронов"
    },
    descriptions: {
      ...
      "zh-CN": "计算航拍和无人机测绘的地面采样距离(GSD)，单位为厘米/像素。输入传感器宽度、飞行高度和焦距即可获得结果。",
      "zh-TW": "計算航拍與無人機測繪的地面採樣距離(GSD)，單位為公分/像素。輸入感測器寬度、飛行高度與焦距即可取得結果。",
      ja: "空撮やドローンマッピングの地上画素寸法(GSD)をcm/ピクセルで計算。センサー幅、飛行高度、焦点距離を入力するだけです。",
      ko: "항공 사진과 드론 매핑의 지상 표본 거리(GSD)를 cm/픽셀로 계산하세요. 센서 폭, 고도, 초점 거리를 입력하면 즉시 결과를 제공합니다.",
      es: "Calcula la distancia de muestreo del terreno (GSD) en cm/píxel para fotografía aérea y mapeo con drones con ancho de sensor, altura y focal.",
      fr: "Calculez la distance d’échantillonnage au sol (GSD) en cm/pixel pour la photo aérienne et la cartographie drone avec capteur, altitude et focale.",
      de: "Berechnen Sie die Ground Sample Distance (GSD) in cm/Pixel für Luftbilder und Drohnenkartierung mit Sensorbreite, Flughöhe und Brennweite.",
      pt: "Calcule a distância de amostragem do solo (GSD) em cm/pixel para fotografia aérea e mapeamento com drones usando sensor, altura e focal.",
      ru: "Рассчитайте Ground Sample Distance (GSD) в см/пиксель для аэросъёмки и картографии с дронов по ширине сенсора, высоте и фокусу."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "jita-xian-zhangli-jisuanqi",
      "zh-TW": "jita-xian-zhangli-jisuanqi",
      ja: "gita-gen-choryoku-keisanki",
      ko: "gita-hyeon-jangnyeok-gyesangi",
      es: "calculadora-tension-cuerdas-guitarra",
      fr: "calculateur-tension-cordes-guitare",
      de: "gitarrensaiten-spannung-rechner",
      pt: "calculadora-tensao-cordas-guitarra",
      ru: "kalkulyator-natyazheniya-strun-gitary"
    },
    titles: {
      en: "Guitar String Tension Calculator - Calculate String Force",
      "zh-CN": "吉他弦张力计算器 - 计算琴弦受力",
      "zh-TW": "吉他弦張力計算器 - 計算琴弦受力",
      ja: "ギター弦張力計算機 - 弦の力を計算",
      ko: "기타 줄 장력 계산기 - 현의 힘 계산",
      es: "Calculadora de tensión de cuerdas de guitarra",
      fr: "Calculateur de tension de cordes de guitare",
      de: "Gitarrensaiten-Spannungsrechner",
      pt: "Calculadora de tensão de cordas de guitarra",
      ru: "Калькулятор натяжения струн гитары"
    },
    descriptions: {
      ...
      "zh-CN": "计算吉他弦张力的磅数和牛顿值。输入弦长、弦径、材质及目标音名或频率，获得精确张力结果。",
      "zh-TW": "計算吉他弦張力的磅數與牛頓值。輸入弦長、弦徑、材質及目標音名或頻率，取得精準張力結果。",
      ja: "ギター弦の張力をポンドとニュートンで計算。スケール長、ゲージ、材質、目標音名または周波数を入力して精密な結果を得られます。",
      ko: "기타 줄 장력을 파운드와 뉴턴으로 계산합니다. 스케일 길이, 게이지, 재질, 목표 음명 또는 주파수를 입력해 정확한 결과를 확인하세요.",
      es: "Calcula la tensión de cuerdas de guitarra en libras y newtons. Ingresa escala, calibre, material y nota o frecuencia objetivo.",
      fr: "Calculez la tension des cordes de guitare en livres et newtons. Entrez diapason, tirant, matériau et note ou fréquence cible.",
      de: "Berechne die Spannung von Gitarrensaiten in Pfund und Newton. Gib Mensur, Stärke, Material und Zielnote oder Frequenz ein.",
      pt: "Calcule a tensão de cordas de guitarra em libras e newtons. Informe escala, calibre, material e nota ou frequência alvo.",
      ru: "Рассчитайте натяжение гитарных струн в фунтах и ньютонах. Укажите мензуру, калибр, материал и целевую ноту или частоту."
    }
  },
  {
    id: "chord-finder",
    ...
    slugs: {
      en: "chord-finder",
      "zh-CN": "xian-chang-yu-hu-chang-ji-suan-qi",
      "zh-TW": "xian-chang-yu-hu-chang-ji-suan-qi",
      ja: "encho-keisanki",
      ko: "won-hyeon-gil-i-gyesangi",
      es: "calculadora-cuerdas-circulo",
      fr: "calculateur-corde-cercle",
      de: "sehnenrechner-kreis",
      pt: "calculadora-corda-circulo",
      ru: "kalkulyator-hordy-kruga"
    },
    titles: {
      ...
      ja: "弦長計算機：円の弦長と弧長",
      ko: "현 길이 계산기: 원의 현과 호",
      es: "Calculadora de cuerdas: cuerda y arco",
      fr: "Calculateur de corde : corde et arc",
      de: "Sehnenrechner: Sehne und Bogen",
      pt: "Calculadora de corda: corda e arco",
      ru: "Калькулятор хорды: хорда и дуга"
    },
    descriptions: {
      ...
      "zh-CN": "输入半径和圆心角，快速计算任意圆的弦长、弧长、扇形面积和弓形面积。",
      "zh-TW": "輸入半徑與圓心角，快速計算任意圓的弦長、弧長、扇形面積與弓形面積。",
      ja: "半径と中心角を入力して、任意の円の弦長、弧長、扇形面積、弓形面積を計算します。",
      ko: "반지름과 중심각을 입력해 원의 현 길이, 호 길이, 부채꼴 넓이, 활꼴 넓이를 계산합니다.",
      es: "Calcula la cuerda, el arco, el área del sector y el área del segmento de cualquier círculo con radio y ángulo central.",
      fr: "Calculez la corde, l’arc, l’aire du secteur et l’aire du segment pour n’importe quel cercle avec le rayon et l’angle central.",
      de: "Berechnen Sie Sehnenlänge, Bogenlänge, Sektorfläche und Segmentfläche für jeden Kreis mit Radius und Mittelpunktswinkel.",
      pt: "Calcule o comprimento da corda, do arco, a área do setor e a área do segmento de qualquer círculo com raio e ângulo central.",
      ru: "Вычисляйте длину хорды, длину дуги, площадь сектора и площадь сегмента для любого круга по радиусу и центральному углу."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "hexian-zhuanwei-jisuanqi",
      "zh-TW": "hexian-zhuanwei-jisuanqi",
      ja: "waon-teni-keisanki",
      ko: "kodeu-jeonwi-gyesangi",
      es: "calculadora-inversion-acordes",
      fr: "calculateur-inversions-accords",
      de: "akkordumkehrungen-rechner",
      pt: "calculadora-inversoes-acordes",
      ru: "obrashcheniya-akkordov"
    },
    titles: {
      ...
      ja: "和音転回計算機",
      ko: "코드 전위 계산기",
      es: "Calculadora de inversiones de acordes",
      fr: "Calculateur d'inversions d'accords",
      de: "Akkordumkehrungen-Rechner",
      pt: "Calculadora de inversões de acordes",
      ru: "Калькулятор обращений аккордов"
    },
    descriptions: {
      ...
      "zh-CN": "计算任意根音与和弦性质的转位和配器，识别低音、和弦符号与音程结构。",
      "zh-TW": "計算任意根音與和弦性質的轉位與配器，辨識低音、和弦符號與音程結構。",
      ja: "任意の根音とコード種類の転回とボイシングを計算し、ベース音、コード記号、音程構造を確認できます。",
      ko: "임의의 근음과 코드 성질에 대한 전위와 보이싱을 계산하고, 베이스 음·코드 기호·음정 구조를 확인합니다.",
      es: "Calcula inversiones y voicings para cualquier nota raíz y calidad. Identifica bajos, símbolos e intervalos.",
      fr: "Calculez les inversions et voicings pour toute fondamentale et qualité. Identifiez basse, symbole et intervalles.",
      de: "Berechnen Sie Umkehrungen und Voicings für jeden Grundton und jede Qualität. Bassnoten, Symbole und Intervalle erkennen.",
      pt: "Calcule inversões e voicings para qualquer nota fundamental e qualidade. Identifique baixo, símbolo e intervalos.",
      ru: "Считайте обращения и voicing для любой тоники и качества. Определяйте бас, символ аккорда и интервалы."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "he-xian-jin-xing-sheng-cheng-qi",
      "zh-TW": "he-xian-jin-xing-sheng-cheng-qi",
      ja: "kodo-shinko-seisei",
      ko: "kodeu-jinhaeng-saengseonggi",
      es: "generador-progresiones-acordes",
      fr: "generateur-progressions-accords",
      de: "akkordfolgen-generator",
      pt: "gerador-progressao-acordes",
      ru: "generator-akkordovyh-progressij"
    },
    titles: {
      en: "Chord Progression Generator - Create Musical Sequences",
      "zh-CN": "和弦进行生成器 - 创建音乐序列",
      "zh-TW": "和弦進行產生器 - 建立音樂序列",
      ja: "コード進行ジェネレーター - 音楽シーケンス作成",
      ko: "코드 진행 생성기 - 음악 시퀀스 만들기",
      es: "Generador de progresiones de acordes",
      fr: "Générateur de progressions d’accords",
      de: "Akkordfolgen-Generator für Musiksequenzen",
      pt: "Gerador de progressões de acordes",
      ru: "Генератор аккордовых прогрессий"
    },
    descriptions: {
      ...
      "zh-CN": "用乐理生成和弦进行。可在任意调性和风格中创建流行、爵士、布鲁斯与古典序列，并附罗马数字分析。",
      "zh-TW": "用樂理產生和弦進行。可在任意調性與風格中建立流行、爵士、藍調與古典序列，並附羅馬數字分析。",
      ja: "音楽理論に基づいてコード進行を生成。任意のキーとスタイルでポップ、ジャズ、ブルース、クラシックの進行を作り、ローマ数字分析も表示します。",
      ko: "음악 이론으로 코드 진행을 생성하세요. 어떤 키와 스타일에서도 팝, 재즈, 블루스, 클래식 진행을 만들고 로마 숫자 분석을 확인할 수 있습니다.",
      es: "Genera progresiones de acordes con teoría musical. Crea secuencias pop, jazz, blues y clásicas en cualquier tonalidad con análisis romano.",
      fr: "Générez des progressions d’accords avec la théorie musicale. Créez des suites pop, jazz, blues et classiques dans toute tonalité avec analyse romaine.",
      de: "Erzeuge Akkordfolgen mit Musiktheorie. Erstelle Pop-, Jazz-, Blues- und Klassik-Sequenzen in jeder Tonart mit römischer Analyse.",
      pt: "Gere progressões de acordes com teoria musical. Crie sequências pop, jazz, blues e clássicas em qualquer tonalidade com análise romana.",
      ru: "Создавайте аккордовые прогрессии по теории музыки: поп, джаз, блюз и классику в любой тональности с анализом римскими цифрами."
    }
  },
  {
    id: "chord-transposer",
    ...
    slugs: {
      en: "chord-transposer",
      "zh-CN": "hexuan-zhuantiaoqi",
      "zh-TW": "hexuan-zhuantiaoqi",
      ja: "kodo-ichou-tsuuru",
      ko: "kodeu-jeonjo-gi",
      es: "transpositor-de-acordes",
      fr: "transpositeur-daccords",
      de: "akkord-transposer",
      pt: "transpositor-de-acordes",
      ru: "transpozitsiya-akkordov"
    },
    titles: {
      ...
      ko: "코드 전조기",
      es: "Transpositor de acordes",
      fr: "Transpositeur d'accords",
      de: "Akkord-Transposer online",
      pt: "Transpositor de acordes",
      ru: "Транспозиция аккордов"
    },
    descriptions: {
      ...
      "zh-CN": "在不同调之间转调和弦与和弦进行，同时保留和弦性质。选择原调和目标调即可立即查看结果。",
      "zh-TW": "在不同調之間轉調和弦與和弦進行，同時保留和弦性質。選擇原調和目標調即可立即查看結果。",
      ja: "コードと進行を保ちながら、元のキーから目的のキーへ移調できます。元キーと移調先を選ぶだけで即座に結果を表示します。",
      ko: "원조와 목표 조 사이에서 코드와 진행을 전조하면서 코드 성질은 유지합니다. 원조와 목표 조를 선택해 즉시 결과를 확인하세요.",
      es: "Transpone acordes y progresiones entre tonalidades sin cambiar la calidad del acorde. Elige la tonalidad original y la de destino.",
      fr: "Transposez accords et progressions entre tonalités en conservant la qualité de l'accord. Choisissez la tonalité d'origine et la cible.",
      de: "Transponiere Akkorde und Folgen zwischen Tonarten, ohne die Akkordqualität zu ändern. Wähle Original- und Zieltonart.",
      pt: "Transponha acordes e progressões entre tonalidades sem alterar a qualidade do acorde. Escolha a tonalidade original e a de destino.",
      ru: "Транспонируйте аккорды и последовательности между тональностями, сохраняя качество аккорда. Выберите исходную и целевую тональность."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "shengdan-daojishi-jisuanqi",
      "zh-TW": "shengdan-daojishi-jisuanqi",
      ja: "kurisumasu-kauntodaun-keisanki",
      ko: "keuriseumaseu-kaunteudaun-gyesangi",
      es: "calculadora-cuenta-regresiva-navidad",
      fr: "compte-rebours-noel",
      de: "weihnachts-countdown-rechner",
      pt: "calculadora-contagem-regressiva-natal",
      ru: "kalkulyator-obratnogo-otscheta-do-rozhdestva"
    },
    titles: {
      en: "Christmas Countdown Calculator - Days Until Christmas",
      "zh-CN": "圣诞倒计时计算器 - 距离圣诞节还有多久",
      "zh-TW": "聖誕倒數計算器 - 距離聖誕節還有多久",
      ja: "クリスマスカウントダウン計算機 - クリスマスまで",
      ko: "크리스마스 카운트다운 계산기 - 크리스마스까지",
      es: "Cuenta regresiva de Navidad - días restantes",
      fr: "Compte à rebours de Noël - jours restants",
      de: "Weihnachts-Countdown-Rechner - Tage bis Weihnachten",
      pt: "Contagem regressiva de Natal - dias restantes",
      ru: "Обратный отсчет до Рождества - дни"
    },
    descriptions: {
      ...
      "zh-CN": "精确计算距离圣诞节或任意重要日期还剩多少天、小时、分钟和秒。支持时区与灵活精度模式。",
      "zh-TW": "精準計算距離聖誕節或任何特定日期還有多少天、小時、分鐘和秒。支援時區與彈性精度模式。",
      ja: "クリスマスや任意の日付までの日数、時間、分、秒を正確に計算。タイムゾーン対応で精度モードも選べます。",
      ko: "크리스마스나 원하는 날짜까지 남은 일, 시간, 분, 초를 정확히 계산하세요. 시간대와 유연한 정밀도 모드를 지원합니다.",
      es: "Calcula con precisión cuántos días, horas, minutos y segundos faltan para Navidad o cualquier fecha especial. Admite zonas horarias.",
      fr: "Calculez précisément les jours, heures, minutes et secondes avant Noël ou toute date spéciale. Gestion des fuseaux horaires incluse.",
      de: "Berechnen Sie exakt Tage, Stunden, Minuten und Sekunden bis Weihnachten oder zu einem beliebigen Datum. Mit Zeitzonen-Unterstützung.",
      pt: "Calcule com precisão quantos dias, horas, minutos e segundos faltam para o Natal ou qualquer data especial. Com suporte a fuso horário.",
      ru: "Точно рассчитайте дни, часы, минуты и секунды до Рождества или любой даты. Поддерживаются часовые пояса и режимы точности."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "16-10-bili-suanqi",
      "zh-TW": "16-10-bili-suanqi",
      ja: "16-10-hiritsu-keisan",
      ko: "16-10-biyul-gyesan-gi",
      es: "16-10-calculadora-ratio",
      fr: "16-10-calculateur-ratio",
      de: "16-10-seitenverhaeltnis-rechner",
      pt: "16-10-calculadora-relacao",
      ru: "16-10-kalkulyator-sootnosheniya"
    },
    titles: {
      ...
      ja: "16:10 比率計算機",
      ko: "16:10 비율 계산기",
      es: "Calculadora de relación 16:10",
      fr: "Calculateur de ratio 16:10",
      de: "16:10-Seitenverhältnis-Rechner",
      pt: "Calculadora de proporção 16:10",
      ru: "Калькулятор соотношения 16:10"
    },
    descriptions: {
      ...
      "zh-CN": "计算显示器和笔记本的 16:10 屏幕尺寸、对角线、像素密度和面积，支持像素、厘米、英寸和毫米。",
      "zh-TW": "計算顯示器與筆電的 16:10 螢幕尺寸、對角線、像素密度與面積，支援像素、公分、英吋與毫米。",
      ja: "モニターやノートPCの16:10画面サイズ、対角線、画素密度、面積を計算。px、cm、インチ、mmに対応。",
      ko: "모니터와 노트북의 16:10 화면 크기, 대각선, 픽셀 밀도, 면적을 계산합니다. 픽셀, cm, 인치, mm 지원.",
      es: "Calcula dimensiones 16:10, diagonal, densidad de píxeles y área para monitores y portátiles. Compatible con px, cm, pulgadas y mm.",
      fr: "Calculez les dimensions 16:10, la diagonale, la densité de pixels et la surface pour écrans et ordinateurs portables. px, cm, pouces et mm pris en charge.",
      de: "Berechnet 16:10-Bildschirmmaße, Diagonale, Pixeldichte und Fläche für Monitore und Laptops. Unterstützt Pixel, cm, Zoll und mm.",
      pt: "Calcule dimensões 16:10, diagonal, densidade de pixels e área para monitores e notebooks. Suporta pixels, cm, polegadas e mm.",
      ru: "Рассчитайте размеры 16:10, диагональ, плотность пикселей и площадь для мониторов и ноутбуков. Поддерживаются px, см, дюймы и мм."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "16-9-pingmu-chicun-jisuanqi",
      "zh-TW": "16-9-pingmu-chicun-jisuanqi",
      ja: "16-9-gamen-saizu-keisanki",
      ko: "16-9-hwamyeon-ki-gyesangi",
      es: "calculadora-proporcion-16-9",
      fr: "calculateur-format-16-9",
      de: "16-9-seitenverhaeltnis-rechner",
      pt: "calculadora-proporcao-16-9",
      ru: "16-9-kalkulyator-sootnosheniya-storon"
    },
    titles: {
      ...
      ja: "16:9 画面サイズ計算機",
      ko: "16:9 화면 크기 계산기",
      es: "Calculadora de proporción 16:9",
      fr: "Calculateur de format 16:9",
      de: "16:9-Seitenverhältnis-Rechner",
      pt: "Calculadora de proporção 16:9",
      ru: "Калькулятор 16:9"
    },
    descriptions: {
      ...
      "zh-CN": "计算电视和显示器的 16:9 屏幕尺寸、对角线、像素密度和面积，支持像素、厘米、英寸和毫米。",
      "zh-TW": "計算電視與顯示器的 16:9 螢幕尺寸、對角線、像素密度與面積，支援像素、厘米、英寸和毫米。",
      ja: "テレビやモニターの16:9画面サイズ、対角線、画素密度、面積を計算。ピクセル、cm、インチ、mmに対応。",
      ko: "TV와 모니터의 16:9 화면 크기, 대각선, 픽셀 밀도, 면적을 계산합니다. 픽셀, cm, 인치, mm 단위를 지원합니다.",
      es: "Calcula dimensiones 16:9, diagonal, densidad de píxeles y área para TVs y monitores. Compatible con píxeles, cm, pulgadas y mm.",
      fr: "Calculez les dimensions 16:9, la diagonale, la densité de pixels et la surface pour TV et moniteurs. Prend en charge les pixels, cm, pouces et mm.",
      de: "Berechne 16:9-Bildschirmmaße, Diagonale, Pixeldichte und Fläche für TVs und Monitore. Unterstützt Pixel, cm, Zoll und mm.",
      pt: "Calcule dimensões 16:9, diagonal, densidade de pixels e área para TVs e monitores. Compatível com pixels, cm, polegadas e mm.",
      ru: "Рассчитайте размеры экрана 16:9, диагональ, плотность пикселей и площадь для телевизоров и мониторов. Поддержка px, см, дюймов и мм."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "3d-dayin-chengben-jisuanqi",
      "zh-TW": "3d-dayin-chengben-jisuanqi",
      ja: "3d-purinto-genka-keisan-ki",
      ko: "3d-peurinting-won-ga-gyesan-gi",
      es: "calculadora-costos-impresion-3d",
      fr: "calculateur-cout-impression-3d",
      de: "3d-druck-kostenrechner",
      pt: "calculadora-custo-impressao-3d",
      ru: "kalkulyator-stoimosti-3d-pechati"
    },
    titles: {
      en: "3D Printing Cost Calculator - Filament & Total Cost",
      "zh-CN": "3D打印成本计算器 - 耗材与总成本",
      "zh-TW": "3D列印成本計算器 - 耗材與總成本",
      ja: "3Dプリント原価計算機 - 材料費と総コスト",
      ko: "3D 프린팅 원가 계산기 - 필라멘트와 총비용",
      es: "Calculadora de costos de impresión 3D - Filamento y total",
      fr: "Calculateur de coût d'impression 3D - Filament et total",
      de: "3D-Druck-Kostenrechner - Filament & Gesamtkosten",
      pt: "Calculadora de custo de impressão 3D - Filamento e total",
      ru: "Калькулятор стоимости 3D-печати - филамент и итог"
    },
    descriptions: {
      ...
      "zh-CN": "计算3D打印项目的完整成本，包括耗材、电费、设备折旧和人工，提供准确的成本明细。",
      "zh-TW": "計算3D列印專案的完整成本，包括耗材、電費、設備折舊與人工，提供準確的成本明細。",
      ja: "フィラメント、電気代、機械償却、人件費を含む3Dプリントの総コストを正確に算出します。",
      ko: "필라멘트, 전기료, 장비 감가상각, 인건비를 포함한 3D 프린팅 총비용을 정확히 계산합니다.",
      es: "Calcula el costo completo de proyectos de impresión 3D, incluyendo filamento, electricidad, depreciación de la máquina y mano de obra.",
      fr: "Calculez le coût complet de vos projets d'impression 3D : filament, électricité, amortissement de la machine et main-d'œuvre.",
      de: "Berechnen Sie die Gesamtkosten von 3D-Druckprojekten inklusive Filament, Strom, Maschinenabschreibung und Arbeit.",
      pt: "Calcule o custo completo de projetos de impressão 3D, incluindo filamento, eletricidade, depreciação da máquina e mão de obra.",
      ru: "Рассчитайте полную стоимость 3D-печатных проектов с учетом филамента, электричества, амортизации оборудования и труда."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "chongji-jiaodu-jisuanqi",
      "zh-TW": "chongji-jiaodu-jisuanqi",
      ja: "shogeki-kakudo-keisanki",
      ko: "chunggyeok-gakdo-gesangi",
      es: "calculadora-angulo-impacto",
      fr: "calculateur-angle-impact",
      de: "aufprallwinkel-rechner",
      pt: "calculadora-angulo-impacto",
      ru: "kalkulyator-ugla-udara"
    },
    titles: {
      ...
      ja: "衝突角計算機",
      ko: "충돌각 계산기",
      es: "Calculadora de ángulo de impacto",
      fr: "Calculateur d'angle d'impact",
      de: "Aufprallwinkel-Rechner",
      pt: "Calculadora de ângulo de impacto",
      ru: "Калькулятор угла удара"
    },
    descriptions: {
      ...
      "zh-CN": "计算任何碰撞的撞击角、出射速度和能量损失。输入速度、角度、恢复系数和质量即可立即得到结果。",
      "zh-TW": "計算任何碰撞的撞擊角、出射速度與能量損失。輸入速度、角度、恢復係數與質量即可立即得到結果。",
      ja: "任意の衝突で、衝突角・離脱速度・エネルギー損失を計算します。速度、角度、反発係数、質量を入力してください。",
      ko: "임의의 충돌에서 충돌각, 이탈 속도, 에너지 손실을 계산합니다. 속도, 각도, 복원계수, 질량을 입력하세요.",
      es: "Calcula el ángulo de impacto, la velocidad de salida y la pérdida de energía en cualquier choque con superficies.",
      fr: "Calculez l'angle d'impact, la vitesse de sortie et la perte d'énergie pour toute collision avec une surface.",
      de: "Berechnen Sie Aufprallwinkel, Austrittsgeschwindigkeit und Energieverlust bei jeder Kollision mit Oberflächen.",
      pt: "Calcule o ângulo de impacto, a velocidade de saída e a perda de energia em qualquer colisão com superfícies.",
      ru: "Рассчитайте угол удара, скорость после столкновения и потери энергии для любого столкновения с поверхностью."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "duizhidian-jisuanqi",
      "zh-TW": "duizhidian-jisuanqi",
      ja: "taishokuten-keisanki",
      ko: "daecheokjeom-gyesangi",
      es: "calculadora-antipodas",
      fr: "calculateur-antipodes",
      de: "antipoden-rechner",
      pt: "calculadora-antipodas",
      ru: "kalkulyator-antipodov"
    },
    titles: {
      ...
      "zh-TW": "對跖點計算器 - 尋找地球對面",
      ja: "対蹠点計算機 - 地球の反対側を探す",
      ko: "대척점 계산기 - 지구 반대편 찾기",
      es: "Calculadora de antípodas - Punto opuesto",
      fr: "Calculateur d'antipodes - Point opposé",
      de: "Antipoden-Rechner - Gegenpunkt der Erde",
      pt: "Calculadora de Antípodas - Ponto oposto da Terra",
      ru: "Калькулятор антиподов - Противоположная точка"
    },
    descriptions: {
      ...
      "zh-CN": "输入任意地点的纬度和经度，立即计算其对跖坐标和大圆距离。",
      "zh-TW": "輸入任意地點的緯度和經度，立即計算其對跖座標與大圓距離。",
      ja: "任意の地点の緯度・経度を入力して、対蹠座標と大圏距離をすぐに計算します。",
      ko: "임의의 위치의 위도와 경도를 입력해 대척 좌표와 대원 거리를 즉시 계산합니다.",
      es: "Encuentra las coordenadas antípodas exactas de cualquier lugar y su distancia de gran círculo.",
      fr: "Trouvez les coordonnées antipodales exactes de n'importe quel lieu et la distance du grand cercle.",
      de: "Finde die exakten antipodalen Koordinaten und die Großkreisentfernung.",
      pt: "Encontre as coordenadas antípodas exatas de qualquer lugar e a distância de grande círculo.",
      ru: "Найдите точные антиподальные координаты любого места и расстояние по большому кругу."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "yu-gang-ji-suan-qi",
      "zh-TW": "yu-gang-ji-suan-qi",
      ja: "suisou-keisanki",
      ko: "eohang-gyesangi",
      es: "calculadora-acuario",
      fr: "calculatrice-aquarium",
      de: "aquarium-rechner",
      pt: "calculadora-aquario",
      ru: "kalkulyator-akvariuma"
    },
    titles: {
      en: "Aquarium Calculator - Volume, Fish Capacity & Maintenance",
      "zh-CN": "鱼缸计算器：水量、鱼量与维护",
      "zh-TW": "魚缸計算機：水量、魚量與維護",
      ja: "水槽計算機：水量・魚数・メンテナンス",
      ko: "어항 계산기: 수량·어류 수용량·관리",
      es: "Calculadora de acuario: volumen y peces",
      fr: "Calculatrice d'aquarium : volume et entretien",
      de: "Aquarium-Rechner: Volumen und Besatz",
      pt: "Calculadora de aquário: volume e manutenção",
      ru: "Калькулятор аквариума: объем и уход"
    },
    descriptions: {
      ...
      "zh-CN": "计算鱼缸水体积、安全养鱼量、过滤流量和每周换水量，帮助你科学规划水族缸。",
      "zh-TW": "計算魚缸水體積、安全養魚量、過濾流量與每週換水量，協助你科學規劃水族缸。",
      ja: "水槽の水量、安全な魚数、必要なろ過流量、週ごとの換水量を計算できます。",
      ko: "어항의 물량, 안전한 어류 수용량, 필요한 여과 유량, 주간 환수량을 계산합니다.",
      es: "Calcula el volumen del acuario, la capacidad segura de peces, el caudal de filtración y el cambio semanal de agua.",
      fr: "Calculez le volume, la capacité de poissons sûre, le débit de filtration et le changement d'eau hebdomadaire.",
      de: "Berechnen Sie Wasservolumen, sichere Fischbesatzdichte, Filterdurchfluss und wöchentliche Wasserwechselmenge.",
      pt: "Calcule o volume do aquário, a capacidade segura de peixes, a vazão de filtragem e a troca semanal de água.",
      ru: "Рассчитайте объем аквариума, безопасную плотность рыб, расход фильтра и еженедельную подмену воды."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "yugang-boli-houdu-jisuanqi",
      "zh-TW": "yugang-boli-houdu-jisuanqi",
      ja: "suiso-garasu-atsusa-keisanki",
      ko: "sujo-yuri-dukke-gyesangi",
      es: "calculadora-grosor-vidrio-acuario",
      fr: "calculateur-epaisseur-verre-aquarium",
      de: "aquarium-glasdickenrechner",
      pt: "calculadora-espessura-vidro-aquario",
      ru: "kalkulyator-tolshchiny-stekla-akvariuma"
    },
    titles: {
      ...
      ja: "水槽ガラス厚さ計算機",
      ko: "수조 유리 두께 계산기",
      es: "Calculadora de grosor del vidrio del acuario",
      fr: "Calculateur d'épaisseur de verre d'aquarium",
      de: "Aquarium-Glasdickenrechner",
      pt: "Calculadora de espessura do vidro do aquário",
      ru: "Калькулятор толщины стекла аквариума"
    },
    descriptions: {
      ...
      "zh-CN": "根据尺寸、水压和材料安全系数，计算鱼缸所需的最小安全玻璃厚度。",
      "zh-TW": "依尺寸、水壓與材料安全係數，計算魚缸所需的最小安全玻璃厚度。",
      ja: "寸法、水圧、材料の安全係数から、水槽に必要な最小の安全ガラス厚さを計算します。",
      ko: "치수, 수압, 재료 안전계수로 수조에 필요한 최소 안전 유리 두께를 계산합니다.",
      es: "Calcula el grosor mínimo seguro del vidrio de un acuario según dimensiones, presión del agua y factor de seguridad.",
      fr: "Calculez l'épaisseur minimale sûre du verre d'un aquarium selon ses dimensions, la pression de l'eau et la marge de sécurité.",
      de: "Berechnen Sie die minimale sichere Glasdicke für Aquarien anhand von Maßen, Wasserdruck und Sicherheitsfaktor.",
      pt: "Calcule a espessura mínima segura do vidro de qualquer aquário com base nas dimensões, na pressão da água e no fator de segurança.",
      ru: "Рассчитайте минимальную безопасную толщину стекла для аквариума по размерам, давлению воды и коэффициенту запаса."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "kuan-gao-bi-ji-suan-qi",
      "zh-TW": "kuan-gao-bi-ji-suan-qi",
      ja: "asuperuto-hikei-keisanki",
      ko: "hwamyeon-bi-yul-gyesangi",
      es: "calculadora-relacion-aspecto",
      fr: "calculateur-format-image",
      de: "seitenverhaeltnis-rechner",
      pt: "calculadora-proporcao-tela",
      ru: "kalkulyator-sootnosheniya-storon"
    },
    titles: {
      en: "Aspect Ratio Calculator - Screen, Video & Image Ratios",
      "zh-CN": "宽高比计算器 - 屏幕、视频和图片比例",
      "zh-TW": "寬高比計算器 - 螢幕、影片與圖片比例",
      ja: "アスペクト比計算機 - 画面・動画・画像比率",
      ko: "화면 비율 계산기 - 화면·동영상·이미지 비율",
      es: "Calculadora de relación de aspecto - pantalla y vídeo",
      fr: "Calculateur de format d’image - écran, vidéo, photo",
      de: "Seitenverhältnis-Rechner - Bildschirm, Video, Bild",
      pt: "Calculadora de proporção de tela - vídeo e imagem",
      ru: "Калькулятор соотношения сторон - экран, видео, фото"
    },
    descriptions: {
      ...
      "zh-CN": "计算任意显示器、视频或图片的宽高比，立即获取简化 W:H 比例、小数值和最接近的标准格式名称。",
      "zh-TW": "計算任何顯示器、影片或圖片的寬高比，立即取得簡化 W:H 比例、小數值與最接近的標準格式名稱。",
      ja: "任意のディスプレイ、動画、画像のアスペクト比を計算し、簡約 W:H 比、小数値、最も近い標準形式名をすぐに表示します。",
      ko: "디스플레이, 동영상, 이미지의 화면 비율을 계산하고 간단한 W:H 비율, 소수값, 가장 가까운 표준 형식을 즉시 확인하세요.",
      es: "Calcula la relación de aspecto de cualquier pantalla, vídeo o imagen y obtén al instante la proporción W:H, el valor decimal y el formato estándar más cercano.",
      fr: "Calculez le rapport largeur/hauteur d’un écran, d’une vidéo ou d’une image et obtenez le ratio W:H, la valeur décimale et le format standard le plus proche.",
      de: "Berechne das Seitenverhältnis von Display, Video oder Bild und erhalte sofort W:H-Verhältnis, Dezimalwert und das nächste Standardformat.",
      pt: "Calcule a proporção de qualquer tela, vídeo ou imagem e veja na hora a razão W:H simplificada, o valor decimal e o formato padrão mais próximo.",
      ru: "Рассчитайте соотношение сторон экрана, видео или изображения и сразу получите W:H, десятичное значение и ближайший стандартный формат."
    }
  }
];
