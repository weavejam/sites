...
export const tools: ToolEntry[] = [
  ...
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "xiangshang-quzheng-jisuanqi",
      "zh-TW": "xiangshang-quzheng-jisuanqi",
      ja: "kiriage-kansu-keisanki",
      ko: "cheonjang-hamsu-gyesangi",
      es: "calculadora-funcion-techo",
      fr: "calculateur-fonction-plafond",
      de: "deckenfunktion-rechner",
      pt: "calculadora-funcao-teto",
      ru: "kalkulyator-funkcii-potolka"
    },
    titles: {
      en: "Ceiling Function Calculator - Round Up to Nearest Integer",
      "zh-CN": "向上取整函数计算器 - 取到最小整数",
      "zh-TW": "向上取整函數計算機 - 取到最小整數",
      ja: "切り上げ関数計算機 - 整数へ切り上げ",
      ko: "천장 함수 계산기 - 정수로 올림",
      es: "Calculadora de función techo - Redondeo hacia arriba",
      fr: "Calculateur de fonction plafond - Arrondi supérieur",
      de: "Deckenfunktion-Rechner - Auf ganze Zahl aufrunden",
      pt: "Calculadora da função teto - Arredondar para inteiro",
      ru: "Калькулятор функции потолка — округление вверх"
    },
    descriptions: {
      ...
      "zh-CN": "向上取整函数计算器可求出大于或等于 x 的最小整数，支持正数、负数和小数，结果即时显示。",
      "zh-TW": "向上取整函數計算機可求出大於或等於 x 的最小整數，支援正數、負數與小數，結果即時顯示。",
      ja: "切り上げ関数計算機は、x 以上で最小の整数を求めます。正数・負数・小数に対応し、即座に結果を表示します。",
      ko: "천장 함수 계산기는 x 이상인 가장 작은 정수를 구합니다. 양수, 음수, 소수도 즉시 계산합니다.",
      es: "Calcula el menor entero mayor o igual que x. Funciona con positivos, negativos y decimales con resultados instantáneos.",
      fr: "Calcule le plus petit entier supérieur ou égal à x. Gère les positifs, les négatifs et les décimales instantanément.",
      de: "Berechnet die kleinste ganze Zahl größer oder gleich x. Für positive, negative und Dezimalzahlen mit sofortigem Ergebnis.",
      pt: "Calcula o menor inteiro maior ou igual a x. Funciona com positivos, negativos e decimais com resultado instantâneo.",
      ru: "Вычисляет наименьшее целое число, большее или равное x. Поддерживает положительные, отрицательные и дробные числа."
    }
  },
  {
    ...
    slugs: {
      ...
      "zh-CN": "zhongxin-zhi-jisuanqi",
      "zh-TW": "zhongxin-zhi-jisuanqi",
      ja: "jushin-keisanki",
      ko: "jungsim-gyeolsangi",
      es: "calculadora-centro-masa",
      fr: "calculatrice-centre-masse",
      de: "schwerpunkt-rechner",
      pt: "calculadora-centro-massa",
      ru: "tsentr-massy-kalkulyator"
    },
    titles: {
      ...
      ja: "重心計算機 - 多点質量系統",
      ko: "질량중심 계산기 - 다점 질량계",
      es: "Calculadora de centro de masa - masas puntuales",
      fr: "Calculatrice du centre de masse - masses ponctuelles",
      de: "Schwerpunkt-Rechner für Punktmassen",
      pt: "Calculadora de centro de massa - massas pontuais",
      ru: "Калькулятор центра масс - точечные массы"
    },
    descriptions: {
      ...
      "zh-CN": "在二维中根据质量和 x、y 坐标快速计算质心，使用加权平均公式立即得到结果。",
      "zh-TW": "在二維中依質量與 x、y 座標快速計算質心，立即套用加權平均公式取得結果。",
      ja: "2次元の質点の質量と x,y 座標から、加重平均式で重心をすばやく計算します。",
      ko: "2차원에서 질량과 x,y 좌표로 질량중심을 가중평균 공식으로 빠르게 계산합니다.",
      es: "Calcula al instante el centro de masa en 2D con masas y coordenadas x,y usando la fórmula de promedio ponderado.",
      fr: "Calculez instantanément le centre de masse en 2D à partir de masses et de coordonnées x,y avec la formule de moyenne pondérée.",
      de: "Berechnen Sie den Schwerpunkt in 2D sofort aus Massen und x,y-Koordinaten mit der gewichteten Mittelwertformel.",
      pt: "Calcule instantaneamente o centro de massa em 2D com massas e coordenadas x,y usando a fórmula da média ponderada.",
      ru: "Мгновенно вычисляйте центр масс в 2D по массам и координатам x,y по формуле взвешенного среднего."
    }
  },
  {
